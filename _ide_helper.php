 ...
 * Generated for Laravel 5.4.36 on 2018-08-16 15:55:18.
 *
...
namespace Latrell\Captcha\Facades { 
    ...
    class Captcha {
        ...
        public static function instance()
        {
            return \Latrell\Captcha\Captcha::instance();
        }
        ...
        {
            return \Latrell\Captcha\Captcha::create();
        }
        
        /**
         * 验证码验证器
         *
         * @param string $attribute 待验证属性的名字
         * @param string $value 待验证属性的值
         * @param array $parameters 传递给这个规则的参数
         * @static 
         */ 
        public static function check($value)
        {
            return \Latrell\Captcha\Captcha::check($value);
        }
        ...
        public static function url()
        {
            return \Latrell\Captcha\Captcha::url();
        }
...
namespace Kryptonit3\Counter\Facades { 
    ...
    class CounterFacade {
         ...
         * @param null|integer $id A unique identifier for mixed page tracking
         * @return string Unique view count for requested resource
         * @static 
         */ 
        public static function show($identifier, $id = null)
        {
            return \Kryptonit3\Counter\Counter::show($identifier, $id);
        }
         ...
         * @static 
         */ 
        public static function showAndCount($identifier, $id = null)
        {
            return \Kryptonit3\Counter\Counter::showAndCount($identifier, $id);
        }
         ...
         * @static 
         */ 
        public static function count($identifier, $id = null)
        {
            return \Kryptonit3\Counter\Counter::count($identifier, $id);
        }
         ...
         * @static 
         */ 
        public static function allHits($days = null)
        {
            return \Kryptonit3\Counter\Counter::allHits($days);
        }
         ...
         * @static 
         */ 
        public static function allVisitors($days = null)
        {
            return \Kryptonit3\Counter\Counter::allVisitors($days);
        }
...
namespace  { 
    ...
    class Captcha extends \Latrell\Captcha\Facades\Captcha {}

    class Config extends \Illuminate\Support\Facades\Config {}

    class Cookie extends \Illuminate\Support\Facades\Cookie {}

    class Counter extends \Kryptonit3\Counter\Facades\CounterFacade {}
