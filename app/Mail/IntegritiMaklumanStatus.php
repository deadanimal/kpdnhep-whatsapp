...
class IntegritiMaklumanStatus extends Mailable
{
    ...
    public function build()
    {
        ...
        $TemplateEmail = Email::where(['email_type'=>'01','email_code'=>'02'])->first();
...
//        $replacements[5] = $this->mPenugasan->negeripengadu->descr;
        ...
        $replacements[6] = nl2br(htmlspecialchars($this->mPenugasan->IN_ANSWER));
