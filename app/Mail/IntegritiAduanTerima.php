...
class IntegritiAduanTerima extends Mailable
{
     ...
     * @return void
     */
    public function __construct(IntegritiPublic $mPubCase)
    {
        //
    ...
    public function build()
    {
        ...
        $replacements[3] = $this->mPubCase->IN_ADDR;
        // if(count($this->mPubCase->daerahpengadu) == 1){
        if($this->mPubCase->daerahpengadu){
...
//        $replacements[4] = $this->mPubCase->daerahpengadu->descr;
        ...
        if($this->mPubCase->negeripengadu){
