...
class DataEntryDocSiasatController extends Controller
{
    /**
...
//    public function create()
    ...
    {
        return view('aduan.dataentrydocsiasat.create', compact('id'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('aduan.dataentrydocsiasat.edit', compact('dataEntryDoc'));
    }
    ...
    {
        $mCaseDoc = DataEntryDoc::where(['CC_CASEID' => $id, 'CC_IMG_CAT' => 2]);
        $datatables = DataTables::of($mCaseDoc)
            ...
            ->addColumn('action', function(DataEntryDoc $dataEntryDoc) {
                return view('aduan.dataentrydocsiasat.actionbutton', compact('dataEntryDoc'))->render();
            })
