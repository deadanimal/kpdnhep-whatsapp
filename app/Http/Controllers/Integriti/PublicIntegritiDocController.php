...
class PublicIntegritiDocController extends Controller
{
    /**
    ...
    {
        return view('integriti.public-integriti-doc.create', compact('id'));
    }
    ...
    {
        // dd($request);
        $model = IntegritiPublic::find($request->IC_CASEID);
        // dd($request, $model);
        if ($model) {
            // dd($request, $model);
        ...
        //            Storage::disk('bahan')->makeDirectory($directory);
            ...
            //                unlink($path);
                    ...
                    $mPublicCaseDoc = new IntegritiPublicDoc();
    ...
    public function edit($id)
    {
        $mPublicCaseDoc = IntegritiPublicDoc::find($id);
        return view('integriti.public-integriti-doc.edit', compact('id', 'mPublicCaseDoc'));
    }
    ...
    public function destroy($id)
    {
        $model = IntegritiPublicDoc::find($id);
        $model->delete();
    ...
    public function getdatatable($id)
    {
        ...
        $modelCaseDoc = IntegritiPublicDoc::
        ...
        $datatables = DataTables::of($modelCaseDoc)
            ->addIndexColumn()
            ->addColumn('action', function (IntegritiPublicDoc $PublicCaseDoc) use ($model){
                return view('integriti.public-integriti-doc.actionbutton', compact('PublicCaseDoc','model'))->render();
            })
            ->editColumn('IC_DOCFULLNAME', function(IntegritiPublicDoc $PublicCaseDoc) {
            ...
            ->editColumn('IC_REMARKS', function(IntegritiPublicDoc $PublicCaseDoc) {
