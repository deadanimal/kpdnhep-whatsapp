...
class TwitterController extends Controller
{
    ...
    {
        $data = FeedTwitter::where('is_active', true)
        ...
        $datatables = DataTables::of($data)
            ->addIndexColumn()
            ->editColumn('phone', function (FeedTwitter $data) {
                return $data->profile->name;
            })
            ->editColumn('last_message', function (FeedTwitter $data) {
                return str_replace(PHP_EOL, '_n_', $data->message ?? '');
            })
            ->editColumn('status', function (FeedTwitter $data) {
                if ($data->is_active == 1) {
                    return 'Aktif';
                } else {
                    return 'Tidak Aktif';
            ...
            ->addColumn('action', '
                <a href="{{ route("twitter.show", $id) }}" class="btn btn-xs btn-primary" data-toggle="tooltip" data-placement="right" title="Add to my task">
    ...
    public function dtMyTask()
    {
        ...
        $datatables = DataTables::of($data)
            ...
            ->addColumn('action', '
                <a href="{{ route("twitter.edit", $id) }}" class="btn btn-xs btn-primary" data-toggle="tooltip" data-placement="right" title="Kemaskini">
    ...
    {
        return view('feedback.twitter.index');
    }

    public function mytask()
    {
        return view('feedback.twitter.mytask');
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('feedback.twitter.show')->with(compact('feeds', 'feed_details', 'is_all'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('feedback.twitter.edit')->with(compact('feeds', 'feed_details', 'is_all'));
    }
    ...
    public function addToMyTask($id)
    {
        ...
        return redirect()->action('Feedback\TwitterController@index');
    }
