 ...
 * AD52 Penyelesaian
 *
 * Laporan Ringkasan Status Aduan Di Bawah Akta Penguatkuasaan Undang-Undang Perdagangan Dalam Negeri
 */
...
class Report6Controller extends Controller
{
    ...
    {
        $title = 'AD52 Laporan Ringkasan Status Aduan Di Bawah Akta Penguatkuasaan Undang-Undang Perdagangan Dalam Negeri';
        $input = $request->all();
        ...
        if ($isSearch) {
            ...
            switch ($gen) {
                case 'xls':
                    return view('laporan.ad52.report6.excelxls', 
                        compact('request', 'title', 'date_start', 'date_end', 'gen', 'actTemplates', 'dataCount')
                    );
                    break;
                case 'pdf':
                    $pdf = PDF::loadView('laporan.ad52.report6.pdf',
                        compact('request', 'title', 'date_start', 'date_end', 'gen', 'actTemplates', 'dataCount')
                    );
                ...
                case 'web':
                default:
                    return view('laporan.ad52.report6.index',
