...
<div class="row">
    <h2>LAPORAN ADUAN MENGIKUT NEGERI DAN KATEGORI ADUAN - KUMULATIF</h2>
        ...
        <div class="form-group" style="padding-bottom: 0px">
            ...
            <div class="col-sm-6 col-sm-offset-3">
                <div class="form-group" align="center">
                    ...
                    {{ link_to('laporanisokumulatif/aduannegeridankategori', 'Semula', ['class' => 'btn btn-default btn-sm']) }}
                </div>
            </div>
            <div class="col-sm-6 col-sm-offset-3">
                <div class="form-group" align="center">
