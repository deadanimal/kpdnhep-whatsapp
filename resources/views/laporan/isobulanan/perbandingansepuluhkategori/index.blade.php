...
@section('content')
<div class="row">
    <h2>PERBANDINGAN SEPULUH (10) KATEGORI ADUAN TERTINGGI - BULANAN</h2>
        ...
        <div class="form-group" style="padding-bottom: 0px">
            ...
            <div class="col-sm-6 col-sm-offset-3">
                <div class="form-group" align="center">
                    ...
                    {{ link_to('laporanisobulanan/perbandingansepuluhkategori', 'Semula', ['class' => 'btn btn-default btn-sm']) }}
                </div>
            </div>
            <div class="col-sm-6 col-sm-offset-3">
                <div class="form-group" align="center">
