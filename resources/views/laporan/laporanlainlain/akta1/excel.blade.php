...
<table style="width: 100%; font-size: 16px; text-align: center">
    <tr>
        <td style="text-align: left;" colspan="12"><h2>Senarai Aduan</h2></td>
    </tr>
    <tr>
        <td style="text-align: left;" colspan="12"><h3>LAPORAN AKTA ADUAN MENGIKUT NEGERI</h3></td>
    </tr>
    <tr>
        <td style="text-align: left;" colspan="12"><p><b>Tarikh:</b> {{ $ds->format('d-m-Y') }} HINGGA {{ $de->format('d-m-Y') }}</p>
        </td>
    </tr>
    <tr>
        <td style="text-align: left;" colspan="12"><p><b>Bahagian:</b> {{ $dp_desc }}</p></td>
    </tr>
    <tr>
        <td style="text-align: left;" colspan="12"><p><b>Negeri:</b> {{ $st_desc }}</p></td>
    </tr>
    <tr>
        <td style="text-align: left;" colspan="12"><p><b>Cawangan:</b> {{ $br_desc }}</p></td>
    </tr>
    <tr>
        <td style="text-align: left;" colspan="12"><p><b>Akta:</b> {{ $ac_desc }}</p></td>
    </tr>
</table>
<table class=""
