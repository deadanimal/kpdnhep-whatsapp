...
<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <h2>LAPORAN MENGIKUT JANTINA DAN KATEGORI ADUAN</h2>
            <div class="ibox-content">
                <div class="row">
                    {!! Form::open(['url' => 'laporanlainlain/laporanjantina', 'id' => 'search-form', 'class'=>'form-horizontal', 'method' => 'GET']) !!}
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="radio radio-success radio-inline">
                                    <input type="radio" name="CA_SEXCD" value="1"  checked="checked" >
                                    <label for="Lelaki"> Lelaki </label>
                                </div>
                                <div class="radio radio-success radio-inline">
                                    <input type="radio" name="CA_SEXCD" value="2"  >
                                    <label for="Perempuan"> Perempuan </label>
                                </div>
                                <div class="radio radio-success radio-inline">
                                    <input type="radio" name="CA_SEXCD" value="3" >
                                    <label for="tidak_dinyatakan"> Tidak Dinyatakan </label>
                                </div>
                ...
                <div class="row"><center>
                        <h3><center>LAPORAN MENGIKUT JANTINA DAN KATEGORI ADUAN BAGI TAHUN LAPORAN SUMBER ADUAN BAGI TAHUN {{ date('d-m-Y', strtotime($CA_RCVDT_dri)) }} HINGGA {{ date('d-m-Y', strtotime($CA_RCVDT_lst)) }}<br/>
                                  @if ($CA_DEPTCD != '')
