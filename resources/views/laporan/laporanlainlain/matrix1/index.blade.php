...
<style>
    ...
    <table style="width: 100%;">
        <tr><td style="text-align: center;"><h3>LAPORAN MATRIX</h3></td></tr>
        <tr><td style="text-align: center;"><h3>BAGI {{ $ds->toDateString() }} HINGGA {{ $de->toDateString() }}</h3></td></tr>
    </table>
{!! Form::open(['method' => 'GET']) !!}
<div class="form-group" align="center">
    <a target="_blank" href="{!! $uri.'&g=e' !!}" class="btn btn-success btn-sm"><i class="fa fa-file-excel-o"></i> Muat Turun Excel</a>
    <a target="_blank" href="{!! $uri.'&g=p' !!}" class="btn btn-success btn-sm"><i class="fa fa-file-pdf-o"></i> Muat Turun PDF</a>
</div>
{!! Form::close() !!}
