...
<table style="width: 100%;">
    <tr><td colspan="18"><center><h3>LAPORAN ADUAN MENGIKUT KATEGORI</h3></center></td></tr>
    <tr><td colspan="18"><center><h3>DARI {{ $request->get('CA_RCVDT_dri') }} HINGGA {{ $request->get('CA_RCVDT_lst') }}</h3></center></td></tr>
</table>
              
                 <table id="state-table" class="table table-bordered" style="width: 100%; font-size: 10px;" border="1">
                        <thead>
                        <tr>
                            <th >Bil.</th>
                            <th>Kategori</th>
