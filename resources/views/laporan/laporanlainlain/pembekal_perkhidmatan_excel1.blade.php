...
<div class="table-responsive">
    <table style="width: 100%;">
        <tr><td colspan="12"><center><h3>LAPORAN PEMBEKAL PERKHIDMATAN</h3></center></td></tr>
        <tr><td colspan="12"><center><h3>DARI {{ $DateFrom }} HINGGA {{ $DateTo }}</h3></center></td></tr>
        <tr><td colspan="12"><center><h3>{{ $titlestate }}</h3></center></td></tr>
        <tr><td colspan="12"><center><h3>{{ $titleprovider }}</h3></center></td></tr>
    </table>
