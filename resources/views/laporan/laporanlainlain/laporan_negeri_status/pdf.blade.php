...
<table style="width: 100%; font-size: 16px; text-align: center">
    <tr>
        <td colspan="11" style="text-align: center;"><h3>LAPORAN STATUS ADUAN MENGIKUT NEGERI</h3></td>
    </tr>
    <tr>
        <td colspan="11" style="text-align: center;"><h3>BAGI {{ $ds->toDateString() }}
                HINGGA {{ $de->toDateString() }}</h3></td>
    </tr>
    <!-- tr -->
        <!-- td colspan="11" style="text-align: center;" -->
            <!-- h3 -->{{-- $department_list[$dp] --}}<!-- /h3 -->
        <!-- /td -->
    <!-- /tr -->
</table>
<table class=""
