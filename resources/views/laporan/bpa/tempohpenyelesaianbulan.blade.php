...
<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <h2>Tempoh Penyelesaian Aduan (Bulan)</h2>
            <div class="ibox-content">
                <div class="row">
                    {!! Form::open(['class'=>'form-horizontal', 'method'=>'GET', 'url'=>'bpa/tempoh-penyelesaian-bulan']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                {{ Form::select('CA_RCVDT_MONTH', Bpa::GetRefList('206', 'semua'), null, ['class' => 'form-control input-sm']) }}
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group" align="center">
                            ...
                            {{ link_to('bpa/tempoh-penyelesaian-bulan', 'Semula', ['class' => 'btn btn-default btn-sm']) }}
                        </div>
                        @if($action)
                            <div class="form-group" align="center">
                ...
                @if($action != '')
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" style="width: 100%">
                            <thead>
                                <h3 align="center">TEMPOH PENYELESAIAN ADUAN (BULAN)</h3>
                                <h3 align="center">
                                    {{ $CA_RCVDT_MONTH != '' ? Ref::GetDescr('206', $CA_RCVDT_MONTH, 'ms') : '' }} {{ $CA_RCVDT_YEAR }}
                                </h3>
                                <h3 align="center">
