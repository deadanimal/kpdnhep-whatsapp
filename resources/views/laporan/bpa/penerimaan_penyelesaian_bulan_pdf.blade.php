...
//                    $selesaiberasasjumlah = $selesaiberasaskerajaan + $selesaiberasasswasta;
                ...
                <!--table 1 - DITERIMA DAN DISELESAIKAN-->
                        ...
                        <tr><td colspan="18"><center><h3>JUMLAH ADUAN YANG DITERIMA DAN DISELESAIKAN BAGI
                                                {{ Ref::GetDescr('206', $CA_RCVDT_MONTH, 'ms') }} {{ $CA_RCVDT_YEAR }}</h3></center></td></tr>
                        <tr><td colspan="18"><center><h3> @if($BR_STATECD != '')
                                                {{ Ref::GetDescr('17', $BR_STATECD, 'ms') }}
                                                @else
                                                SEMUA NEGERI
                                                @endif</h3></center></td></tr>
                        <tr><td colspan="18"><center><h3> @if($CA_DEPTCD != '')
                ...
                <!--table 2 - SELESAI BERASAS DAN TIDAK BERASAS-->
                                          <table style="width: 100%;">
                        <tr><td colspan="18"><center><h3>JUMLAH ADUAN SELESAI YANG BERASAS DAN LUAR BIDANG KUASA
                        </h3></center></td></tr>
                    </table>
                    <table class="table table-striped table-bordered table-hover" style="width: 100%; font-size: 10px; border:1px solid; border-collapse: collapse" border="1">
                        <thead>
                ...
                <!--table 3 - STATUS PENYELESAIAN ADUAN-->
                       <table style="width: 100%;">
                        <tr><td colspan="18"><center><h3>STATUS PENYELESAIAN ADUAN</h3></center></td></tr>
                        </table>
                    <table class="table table-striped table-bordered table-hover" style="width: 100%; font-size: 10px; border:1px solid; border-collapse: collapse" border="1">
                        <thead>
                        <tr>
