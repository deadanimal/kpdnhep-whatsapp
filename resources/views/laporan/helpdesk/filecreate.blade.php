...
<div class="modal-body">
    {!! Form::open(['route' => ['laporan.helpdesk.storeFile', $id], 'id' => 'form-create-attachment', 'class' => 'form-horizontal', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
        {{ csrf_field() }}
        <div id="file_field" class="form-group{{ $errors->has('file') ? ' has-error' : '' }}">
            ...
            {{ Form::hidden('askid', 'LW' . $id, ['class' => 'form-control input-sm']) }}
        </div>
