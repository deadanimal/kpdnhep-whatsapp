    ...
    <div class="tab-content">
        <div id="enq_info" class="tab-pane active">
            <div class="panel-body">
                {!! Form::open(['route' => 'laporan.helpdesk.store','class'=>'form-horizontal', 'method' => 'post']) !!}
                    {{ csrf_field() }}
                   <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group{{ $errors->has('AS_NI') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                {{ Form::text('AS_NI', '', ['class' => 'form-control input-sm', 'id' => 'AS_NI' ]) }}
                                @if ($errors->has('AS_NI'))
                        ...
                        <div class="form-group{{ $errors->has('AS_RCVTYP') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                {{ Form::select('AS_RCVTYP', array('R' => 'Rendah', 'S' => 'Sederhana', 'T' => 'Tinggi'), null, ['class' => 'form-control input-sm']) }}
                        ...
                        <div class="form-group {{ $errors->has('AS_SUMMARY') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    {{ Form::textarea('AS_SUMMARY', '', ['class' => 'form-control input-sm taklebar', 'rows' => 4 ]) }}
