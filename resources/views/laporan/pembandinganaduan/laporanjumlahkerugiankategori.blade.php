...
<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <h2>Laporan Jumlah Kerugian Mengikut Bulan & Kategori Aduan</h2>
            <div class="ibox-content">
                <div class="row">
                    {!! Form::open(['class'=>'form-horizontal', 'method'=>'GET', 'url'=>'pembandinganaduan/laporanjumlahkerugiankategori']) !!}
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                               {{ Form::select('CA_CMPLCAT', ['1' => 'Aktif', '0' => 'Tidak Aktif'], '', ['class' => 'form-control input-sm', 'id' => 'CA_CMPLCAT']) }}
                            </div>
                        </div>
                        <div class="form-group" align="center">
                            {{ Form::submit('Carian', ['class' => 'btn btn-primary btn-sm', 'name'=>'action']) }}
                            {{ link_to('pembandinganaduan/laporanjumlahkerugiankategori', 'Semula', ['class' => 'btn btn-default btn-sm']) }}
                            @if($action)
                            </br>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" style="width: 100%">
                        @if($action != '')
                            <thead>
                                <h3 align="center">LAPORAN JUMLAH KERUGIAN MENGIKUT BULAN & KATEGORI ADUAN</h3>
                                <h3 align="center">
                                    {{ $CA_RCVDT_YEAR }}
                                </h3>
                                <tr>
...
@section('script_datatable')
    <script type="text/javascript">
        ...
        Highcharts.chart('container', {
            ...
            title: {
                text: 'Laporan Jumlah Kerugian Mengikut Bulan & Kategori Aduan'
            },
            subtitle: {
