...
<table style="width: 100%;">
    ...
    <tr><td colspan="15"><center><h3>{{ $titlestate }}</h3></center></td></tr>
</table>
<table id="year-table" class="table table-striped table-bordered table-hover dataTables-example" style="width: 100%" border='1'>
    <thead>
        <tr>
            <th>Bil.</th>
