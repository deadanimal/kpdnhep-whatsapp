...
@section('content')
<div class="row">
    <h2>Laporan Integriti - Statistik Aduan Mengikut Status</h2>
        ...
        <div class="form-group" style="padding-bottom: 0px">
            ...
            <div class="col-sm-6 col-sm-offset-3">
                <div class="form-group" align="center">
                    ...
                    {{ link_to('laporanintegriti/statistikaduanmengikutstatus', 'Semula', ['class' => 'btn btn-default btn-sm']) }}
                </div>
            </div>
            <div class="col-sm-6 col-sm-offset-3">
                <div class="form-group" align="center">
...
<div class="row">
    <div class="ibox-content" style="padding-bottom: 0px">
        <table style="width: 100%;">
            <tr><td><center><h3>Laporan Integriti - Statistik Aduan Mengikut Status dari {{date('d-m-Y', strtotime($DATE_FROM))}} hingga {{date('d-m-Y', strtotime($DATE_TO))}}</h3></center></td></tr>
        </table>
