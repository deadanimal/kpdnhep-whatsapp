    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <h2>LAPORAN MENGIKUT STATUS DAN KATEGORI ADUAN</h2>
                <div class="ibox-content">
                    <div class="row">
                        {!! Form::open(['url' => 'penerimaanpenyelesaianaduan/laporan_kategori_BPGK', 'id' => 'search-form', 'class'=>'form-horizontal', 'method' => 'GET']) !!}
                        ...
                        <div class="col-sm-12">
                            ...
                            <div align="center">
                                {{ Form::label('', 'Pilihan Kategori Aduan') }}
                            </div>
                            <div class="col-md-12">
                                <div class="ibox">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group" align="center">
                                ...
                                <a class="btn btn-default btn-sm"
                                    href="{{ url('penerimaanpenyelesaianaduan/laporan_kategori_BPGK')}}">
                        ...
                        @if($search)
                            <div class="col-sm-12">
                                <div class="form-group" align="center">
                                    <a target="_blank"
                                       href="/penerimaanpenyelesaianaduan/laporan_kategori_BPGK?dateStart={!! $dateStart->format('d-m-Y') !!}&dateEnd={!! $dateEnd->format('d-m-Y') !!}&state={!! $state !!}&{!! $branchUri !!}&department={!! $department !!}&{!! $subdepartmentUri !!}&gen=excel"
                                       class="btn btn-success btn-sm">
                                        <i class="fa fa-file-excel-o"></i> Muat Turun Versi Excel
                                    </a>
                                    <a target="_blank" 
                                       href="/penerimaanpenyelesaianaduan/laporan_kategori_BPGK?dateStart={!! $dateStart->format('d-m-Y') !!}&dateEnd={!! $dateEnd->format('d-m-Y') !!}&state={!! $state !!}&{!! $branchUri !!}&department={!! $department !!}&{!! $subdepartmentUri !!}&gen=pdf"
                                       class="btn btn-success btn-sm">
                    ...
                    @if($search)
                        <div class="row">
                            <div style="text-align: center;">
                                <h3>
                                    <div style="text-align: center;">
                                        <p>LAPORAN MENGIKUT STATUS DAN KATEGORI ADUAN</p>
                                        ...
                                        <p>BAHAGIAN : {{ !empty($department) ? Ref::GetDescr('315', $department) : 'SEMUA BAHAGIAN' }}</p>
                                    </div>
                                </h3>
                            </div>
...
<!--                                        <tr>
                                    ...
                                    @if($datum['total'] > 0)
                                        <tr>
                                            ...
                                            <td><a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd={!! $key !!}&cs=&is[]=0&is[]=1&is[]=2&is[]=3&is[]=4&is[]=5&is[]=6&is[]=7&is[]=8&is[]=9&is[]=11&is[]=12">{{$datum['total']}}</a></td>
                                            <td><a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd={!! $key !!}&cs=&is[]=0&is[]=1">{{$datum['belum agih']}}</a></td>
                                            <td><a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd={!! $key !!}&cs=&is=2">{{$datum['dalam siasatan']}}</a></td>
                                            <td><a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd={!! $key !!}&cs=&is=7">{{$datum['maklumat tak lengkap']}}</a></td>
                                            <td><a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd={!! $key !!}&cs=&is[]=3&is[]=12">{{$datum['selesai']}}</a></td>
                                            <td><a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd={!! $key !!}&cs=&is[]=9&is[]=11">{{$datum['tutup']}}</a></td>
                                            <td><a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd={!! $key !!}&cs=2&is=4">{{$datum['agensi lain']}}</a></td>
                                            <td><a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd={!! $key !!}&cs=&is=5">{{$datum['tribunal']}}</a></td>
                                            <td><a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd={!! $key !!}&cs=&is=6">{{$datum['pertanyaan']}}</a></td>
                                            <td><a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd={!! $key !!}&cs=&is=8">{{$datum['luar bidang']}}</a></td>
                                            <!--<td><a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd={!! $key !!}&cs=3&is=">{{-- $datum['belum selesai'] --}}</a></td>-->
                                        </tr>
                                    @endif
                                    @endforeach
                                    </tbody>
                                    <tfooter>
                                        <tr>
                                            ...
                                            <th>Jumlah</th>
                                            <th>
                                                <a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd=&cs=&is[]=0&is[]=1&is[]=2&is[]=3&is[]=4&is[]=5&is[]=6&is[]=7&is[]=8&is[]=9&is[]=11&is[]=12">
                                                    {{$dataCounter['total']}}
                                                </a>
                                            </th>
                                            <th>
                                                <a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd=&cs=&is[]=0&is[]=1">
                                                    {{$dataCounter['belum agih']}}
                                                </a>
                                            </th>
                                            <th>
                                                <a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd=&cs=&is=2">
                                                    {{$dataCounter['dalam siasatan']}}
                                                </a>
                                            </th>
                                            <th>
                                                <a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd=&cs=&is=7">
                                                    {{$dataCounter['maklumat tak lengkap']}}
                                                </a>
                                            </th>
                                            <th>
                                                <a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd=&cs=&is[]=3&is[]=12">
                                                    {{$dataCounter['selesai']}}
                                                </a>
                                            </th>
                                            <th>
                                                <a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd=&cs=&is[]=9&is[]=11">
                                                    {{$dataCounter['tutup']}}
                                                </a>
                                            </th>
                                            <th>
                                                <a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd=&cs=2&is=4">
                                                    {{$dataCounter['agensi lain']}}
                                                </a>
                                            </th>
                                            <th>
                                                <a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd=&cs=&is=5">
                                                    {{$dataCounter['tribunal']}}
                                                </a>
                                            </th>
                                            <th>
                                                <a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd=&cs=&is=6">
                                                    {{$dataCounter['pertanyaan']}}
                                                </a>
                                            </th>
                                            <th>
                                                <a target="_blank" href="laporan_kategori_BPGK/dd?{!! $dd_uri !!}&sd=&cs=&is=8">
