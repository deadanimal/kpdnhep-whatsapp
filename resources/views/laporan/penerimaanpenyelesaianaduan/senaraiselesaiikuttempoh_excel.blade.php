...
<div class="ibox-content">
    ...
    <table style="width: 100%;">
        <tr><td colspan="9"><h3><center>LAPORAN PENYELESAIAN ADUAN NEGERI</center></h3></td></tr>
        <tr><td colspan="9"><h3><center>{{ date('d-m-Y', strtotime($CA_RCVDT_FROM)) }} <?php echo $CA_RCVDT_TO != '' ? 'hingga' : ''; ?> {{ date('d-m-Y', strtotime($CA_RCVDT_TO)) }}</center></h3></td></tr>
        <tr><td colspan="9"><h3><center><?php echo $CA_DEPTCD != '' ? Ref::GetDescr('315', $CA_DEPTCD) : 'Semua Bahagian' ?></center></h3></td></tr>
    </table>
