...
<table style="width: 100%;">
    <!--<tr>-->
        ...
        <!--</td>-->
    <!--</tr>-->
    <tr><td style="text-align: center;"><h3>LAPORAN MENGIKUT STATUS DAN CARA PENERIMAAN ADUAN BAGI</h3></td></tr>
...
<table class="table table-striped table-bordered table-hover" style="width: 100%; font-size: 10px; border:1px solid; border-collapse: collapse" border="1">
    <thead>
        <tr>
            ...
            <th style="border: 1px solid #000; background: #f3f3f3;">Cara Penerimaan Aduan</th>
    ...
    <tbody>
        ...
        @foreach($data_final as $data)
            <tr>
                ...
                <td>{{ $data->BR_BRNNM }}</td>
                <td>{{ $data->CA_RCVTYP? $data->RcvTyp->descr : $data->CA_RCVTYP }}</td>
