        ...
        <table style="width: 100%;">
            <tr>
                <td style="text-align: center;">
                    <h3>LAPORAN MENGIKUT STATUS DAN CARA PENERIMAAN ADUAN</h3>
                </td>
            </tr>
            <tr>
                <td style="text-align: center;">
                    <h3>DARI {{ \Carbon\Carbon::parse($date_start)->toDateString() }}
                        HINGGA {{ \Carbon\Carbon::parse($date_end)->toDateString() }}</h3>
                </td>
            </tr>
            <tr>
                <td style="text-align: center;">
            ...
            <tr>
                <td style="text-align: center;">
                    <h3>CARA PENERIMAAN : {{ !empty($subdepartment) ? Ref::GetDescr('259', $subdepartment, 'ms') : 'Semua' }}</h3>
                </td>
            </tr>
            {!! Form::open(['method' => 'GET']) !!}
                <div class="form-group" align="center">
                    ...
                    <div class="form-group" align="center">
                        <a target="_blank" href="{!! $uri_gen.'&ge=e' !!}" class="btn btn-success btn-sm"><i class="fa fa-file-excel-o"></i> Muat Turun Excel</a>
                        <a target="_blank" href="{!! $uri_gen.'&ge=p' !!}" class="btn btn-success btn-sm"><i class="fa fa-file-pdf-o"></i> Muat Turun PDF</a>
                    </div>
                </div>
            {!! Form::close() !!}
        </table>
            ...
            <tbody>
                ...
                @foreach($data_final as $data)
                    <tr>
                        ...
                        <td>{{ $data->RcvTyp ? $data->RcvTyp->descr : $data->CA_RCVTYP }}</td>
