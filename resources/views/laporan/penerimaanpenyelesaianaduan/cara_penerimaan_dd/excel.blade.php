<?php
    use App\Ref;
    $filename = 'Laporan_Mengikut_Status_Dan_Cara_Penerimaan_Aduan_Drilldown_'.date('YmdHis').'.xls';
...
<table style="width: 100%; text-align: center">
    <thead>
    <tr>
        <td colspan="12">LAPORAN MENGIKUT STATUS DAN CARA PENERIMAAN ADUAN</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="12">
            <!--Negeri {{-- $stateDesc --}}-->
            CARA PENERIMAAN : {{ !empty($subdepartment) ? Ref::GetDescr('259', $subdepartment, 'ms') : 'Semua' }}
        </td>
    </tr>
    </thead>
</table>
