    ...
    <table style="width: 100%;">
        <tr>
            <td style="text-align: center;">
                <h3>LAPORAN MENGIKUT STATUS DAN SUBKATEGORI ADUAN BAGI</h3>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
        ...
        <tr>
            <td style="text-align: center;">
                <h3>Negeri : {{ $state != '0' ? Ref::GetDescr('17', $state, 'ms') : 'Semua' }}</h3>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
                <h3>Kategori : {{ $kategori ? Ref::GetDescr('244', $kategori, 'ms') : 'Semua' }}</h3>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
                <h3>Subkategori : {{ $subkategori ? Ref::GetDescr('634', $subkategori, 'ms') : 'Semua' }}</h3>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
