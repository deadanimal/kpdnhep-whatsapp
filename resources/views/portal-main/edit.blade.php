    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                {{-- date('Y-m-d') --}}
                <!--<hr>-->
                {!! Form::open(['url' => ['/article/update',$model->id], 'class'=>'form-horizontal']) !!}
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <div class="form-group {{ $errors->has('start_dt') ? ' has-error' : '' }} " id="start_date">
                        ...
                        <div class="col-sm-3">
                            <div class="input-daterange" id="datepicker">
                                <!--{{-- Form::date('start_dt', $model->start_dt, array_merge(['id' => 'start_dt', 'class' => 'form-control input-sm'])) --}}-->
                                <!--{{ Form::text('start_dt', old('start_dt', $model->start_dt), array_merge(['class' => 'form-control input-sm', 'id' => 'start_dt']), \Carbon\Carbon::now()) }}-->
                                {{ Form::text('start_dt', old('start_dt', $model->start_dt), array_merge(['class' => 'form-control input-sm', 'id' => 'start_dt'])) }}
                            </div>
                    ...
                    <div class="form-group {{ $errors->has('end_dt') ? ' has-error' : '' }}" id="end_date">
                        ...
                        <div class="col-sm-3">
                            <div class="input-daterange" id="datepicker">
                                {{ Form::text('end_dt', old('end_dt', $model->end_dt), array_merge(['id' => 'end_dt', 'class' => 'form-control input-sm'])) }}
                            </div>
                    ...
                    <div class="form-group {{ $errors->has('title_my') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-10">
                            {{ Form::text('title_my', old('title_my', $model->title_my), array_merge(['id' => 'title_my', 'class' => 'form-control input-sm'])) }}
                    ...
                    <div class="form-group {{ $errors->has('title_en') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-10">
                            {{ Form::text('title_en', old('title_en', $model->title_en), array_merge(['id' => 'title_en', 'class' => 'form-control input-sm'])) }}
                    ...
                    <div class="form-group {{ $errors->has('content_my') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-10">
                            {{ Form::textarea('content_my', old('content_my', $model->content_my), array_merge(['id' => 'content_my', 'class' => 'form-control input-sm'])) }}
                    ...
                    <div class="form-group {{ $errors->has('content_en') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-10">
                            {{ Form::textarea('content_en', old('content_en', $model->content_en), array_merge(['id' => 'content_en', 'class' => 'form-control input-sm'])) }}
...
<!--                    <div class="form-group {{ $errors->has('hits') ? ' has-error' : '' }}">
                        {{ Form::label('hits', 'Hits', ['class' => 'col-sm-2 control-label required']) }}
                        <div class="col-sm-10">
                            {{ Form::text('hits', old('hits', $model->hits), array_merge(['id' => 'hits', 'class' => 'form-control input-sm'])) }}
                            @if ($errors->has('hits'))
                                <span class="help-block"><strong>{{ $errors->first('hits') }}</strong></span>
                            @endif
                        </div>
                    </div>-->
...
@section('script_datatable')
    <script>
//        var ckview = document.getElementById("title_my");
//        CKEDITOR.replace(ckview,{
//            language:'ms-gb'
//        });
//        var ckview = document.getElementById("title_en");
//        CKEDITOR.replace(ckview,{
//            language:'ms-gb'
//        });
