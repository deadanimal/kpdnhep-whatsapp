    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-12 col-md-6">
                ...
                {{ Form::select('status_grp', $collections['statusGroup'], null, ['class' => 'form-control', 'placeholder' => '-- SILA PILIH --']) }}
            </div>
            ...
            <div class="form-group col-sm-12 col-md-6">
                ...
                {{ Form::select('status_kes', $collections['statusKes'], null, ['class' => 'form-control', 'placeholder' => '-- SILA PILIH --']) }}
            </div>
            ...
            <div class="form-group col-sm-12 col-md-6">
                ...
                {{ Form::select('status_kes_det', $collections['statusKesDet'], null, ['class' => 'form-control', 'placeholder' => '-- SILA PILIH --']) }}
            </div>
            ...
            {{-- <div class="form-group col-sm-12 col-md-12{{ $errors->has('result_detail') ? ' has-error' : '' }}"> --}}
                {{-- {{ Form::label('result_detail', 'Hasil Siasatan:', ['class' => 'control-label required']) }} --}}
                {{-- {!! Form::textarea('result_detail', null, ['class' => 'form-control']) !!} --}}
                {{-- @if ($errors->has('result_detail')) --}}
                    {{-- <span class="help-block"><strong>{{ $errors->first('result_detail') }}</strong></span> --}}
                {{-- @endif --}}
            {{-- </div> --}}
            <!-- Jawapan Kepada Pengadu Field -->
            {{-- <div class="form-group col-sm-12 col-md-12{{ $errors->has('answer_detail') ? ' has-error' : '' }}"> --}}
                {{-- {{ Form::label('answer_detail', 'Jawapan Kepada Pengadu:', ['class' => 'control-label required']) }} --}}
                {{-- {!! Form::textarea('answer_detail', null, ['class' => 'form-control']) !!} --}}
                {{-- @if ($errors->has('answer_detail')) --}}
                    {{-- <span class="help-block"><strong>{{ $errors->first('answer_detail') }}</strong></span> --}}
                {{-- @endif --}}
            {{-- </div> --}}
        </div>
    </div>
