<div class="row">
    <div class="col-md-6">
    	<div class="form-group {{ $errors->has('complaint_case_no') ? ' has-error' : '' }}">
            {{ Form::label('complaint_case_no', 'Nombor Aduan Kepenggunaan', ['class' => 'control-label required']) }}
            @if(isset($id))
            	<p class="form-control-static">{{ $id }}</p>
            @else
            	<div class="input-group">
            		{{ Form::text('complaint_case_no', null, ['class' => 'form-control', 'placeholder' => 'Nombor Aduan Kepenggunaan, Contoh : 02000001']) }}
            		<span class="input-group-btn">
            			{{ Form::button('Carian '.' <i class="fa fa-search"></i>', ['id' => 'case-act-modal-button', 'class' => 'btn btn-success']) }}
        			</span>
        		</div>
            @endif
            @if ($errors->has('complaint_case_no'))
                <span class="help-block"><strong>{{ $errors->first('complaint_case_no') }}</strong></span>
            @endif
        </div>
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
    	<div class="form-group {{ $errors->has('serahan_agensi') ? ' has-error' : '' }}">
            ...
            <div class="input-group">
                ...
                {{ Form::select('serahan_agensi', $serahanAgensi, null, ['class' => 'form-control', 'placeholder' => '-- SILA PILIH --']) }}
        	</div>
    ...
    <div class="col-md-6">
    	<div class="form-group {{ $errors->has('pengelasan_kes') ? ' has-error' : '' }}">
            ...
            <div class="input-group">
                ...
                {{ Form::select('pengelasan_kes', $pengelasanKes, null, ['class' => 'form-control', 'placeholder' => '-- SILA PILIH --']) }}
        	</div>
