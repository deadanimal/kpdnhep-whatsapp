...
@section('content')
        ...
        {{-- <div class="col-lg-12"> --}}
            {{-- <div class="tabs-container"> --}}
                {{-- <ul class="nav nav-tabs"> --}}
                    {{-- <li class="active"> --}}
                        {{-- <a data-toggle="tab">Maklumat Am <span class="label label-success">1</span></a> --}}
                    {{-- </li> --}}
                    {{-- <li> --}}
                        {{-- <a href="{{ route('caseenquirypaper.dataentries.processes.edit', ['id' => $caseEnquiryPaper->id, 'page' => 2]) }}"> --}}
                            {{-- Maklumat OKT <span class="label label-success">2</span> --}}
                        {{-- </a> --}}
                    {{-- </li> --}}
                    {{-- <li> --}}
                        {{-- <a href="{{ route('caseenquirypaper.dataentries.processes.edit', ['id' => $caseEnquiryPaper->id, 'page' => 3]) }}"> --}}
                ...
                {{-- <div class="tab-content"> --}}
                    {{-- <div class="tab-pane active"> --}}
                        {{-- <div class="panel-body"> --}}
                            ...
                            {{ Form::close() }} --}}
                            {{-- {{ Form::model($caseEnquiryPaper, ['route' => ['caseenquirypaper.dataentries.update', $caseEnquiryPaper->NO_KES], 'method' => 'put']) }} --}}
                            {{-- {{ Form::model($caseEnquiryPaper, ['route' => ['caseenquirypaper.dataentries.update', $caseEnquiryPaper->id], 'method' => 'put']) }} --}}
    ...
    <div class="row">
        {{ Form::model($caseEnquiryPaper, ['route' => ['caseenquirypaper.dataentries.update', $caseEnquiryPaper->id], 'method' => 'patch']) }}
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
