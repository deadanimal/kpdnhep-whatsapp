...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="tabs-container">
                <ul class="nav nav-tabs">
                    <li><a>Maklumat Am <span class="label label-success">1</span></a></li>
                    <li class="active">
                        <a data-toggle="tab">Maklumat Inventori <span class="label label-success">2</span></a>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane active">
                        <div class="panel-body">
                            {{-- {{ Form::open(['route' => 'caseenquirypaper.dataentries.store']) }}
                                @include('caseenquirypaper.dataentry.form1')
                            {{ Form::close() }} --}}
                            {{ Form::model($caseEp, ['route' => ['caseenquirypaper.dataentryprocess.update', $caseEp->NO_KES], 'method' => 'put']) }}
                                {{-- @include('caseenquirypaper.dataentryprocess.formpage2') --}}
                                @include('caseenquirypaper.dataentryprocess.fields')
                            {{ Form::close() }}
                        </div>
                    </div>
                </div>
    ...
    @include('caseenquirypaper.dataentry.caseactmodal')
@endsection
