        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    {!! Form::open(['url' => ['agensi'],'class'=>'form-horizontal', 'method' => 'POST']) !!}
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('MI_MINCD', old('MI_MINCD'), ['class' => 'form-control input-sm']) }}
                                </div>
                            </div>
                            <div class="form-group{{ $errors->has('MI_ADDR') ? ' has-error' : '' }}">
                                {{ Form::label('MI_ADDR', 'Alamat', ['class' => 'col-md-3 control-label required']) }}
                                <div class="col-sm-9">
                                    {{ Form::textarea('MI_ADDR', old('MI_ADDR'), ['class' => 'form-control input-sm','rows'=>'3']) }}
                            ...
                            <div class="form-group{{ $errors->has('MI_POSCD') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('MI_POSCD', old('MI_POSCD'), ['class' => 'form-control input-sm']) }}
                            ...
                            <div class="form-group{{ $errors->has('MI_STATECD') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::select('MI_STATECD', Ref::GetList('17', true), old('MI_STATECD'), ['class' => 'form-control input-sm required', 'id' => 'MI_STATECD']) }}
                            ...
                            <div class="form-group{{ $errors->has('MI_DISTCD') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::select('MI_DISTCD', old('MI_DISTCD') == ''? [''=>'-- SILA PILIH --'] : Ref::GetListDist(old('MI_STATECD'), '18', true, 'ms'), old('MI_DISTCD'), ['class' => 'form-control input-sm', 'id' => 'MI_DISTCD']) }}
                        ...
                        <div class="col-sm-7">
                            <div class="form-group{{ $errors->has('MI_DESC') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    {{ Form::text('MI_DESC', old('MI_DESC'), ['class' => 'form-control input-sm']) }}
                            ...
                            <div class="form-group{{ $errors->has('MI_TELNO') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    {{ Form::text('MI_TELNO', old('MI_TELNO'), ['class' => 'form-control input-sm']) }}
                                    @if ($errors->has('MI_DESC'))
                            ...
                            <div class="form-group{{ $errors->has('MI_FAXNO') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    {{ Form::text('MI_FAXNO', old('MI_FAXNO'), ['class' => 'form-control input-sm']) }}
                            ...
                            <div class="form-group{{ $errors->has('MI_EMAIL') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    {{ Form::text('MI_EMAIL', old('MI_EMAIL'), ['class' => 'form-control input-sm']) }}
                            ...
                            <div class="form-group{{ $errors->has('MI_OFFNM') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    {{ Form::text('MI_OFFNM', old('MI_OFFNM'), ['class' => 'form-control input-sm']) }}
                            ...
                            <div class="form-group{{ $errors->has('MI_MINTYP') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    <div class="radio radio-primary radio-inline">
                                        <input id="gov" type="radio" value="1" name="MI_MINTYP" checked>
                                        <label for="gov">KERAJAAN</label>
                                    </div>
                                    <div class="radio radio-primary radio-inline">
                                        <input id="swasta" type="radio" value="2" name="MI_MINTYP">
                            ...
                            <div class="form-group{{ $errors->has('MI_STS') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    <div class="radio radio-primary radio-inline">
                                        <input id="active" type="radio" value="1" name="MI_STS" checked>
                                        <label for="active">AKTIF</label>
                                    </div>
                                    <div class="radio radio-primary radio-inline">
                                        <input id="notactive" type="radio" value="0" name="MI_STS">
