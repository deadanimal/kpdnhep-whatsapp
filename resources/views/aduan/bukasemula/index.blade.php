...
<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <h2>Senarai Buka Semula Aduan</h2>
            @include('nota')
            <div class="ibox-content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                {{ Form::select('CA_INVSTS', BukaSemula::GetStatusList(), null, ['class' => 'form-control input-sm', 'id' => 'CA_INVSTS']) }}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group" align="center">
                    ...
                    {{ link_to('bukasemula', 'Semula', ['class' => 'btn btn-default btn-sm']) }}
                </div>
                {!! Form::close() !!}
...
//                {extend: 'excel'},
            ...
            ajax: {
                url: "{{ url('bukasemula/getdatatablecase') }}",
                data: function (d) {
