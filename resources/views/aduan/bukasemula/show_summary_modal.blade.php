    ...
    <div class="row">
        ...
        <table style="width: 100%; " class="table-bordered table-stripped">
            ...
            <tr>
                ...
                <td style="width: 1%;">:</td>
                <td>@if($model->CA_ASGBY!=''){{$model->AsgBy->name}}@endif</td>
        ...
        <table style="width: 100%; " class="table-bordered table-stripped">
            ...
            <tr>
                ...
                <td> : </td>
                <td>@if($model->CA_ONLINECMPL_IND!='' || $model->CA_ONLIENCMPL_IND!=NULL){{$model->CA_ONLINECMPL_CASENO}}@endif</td>
            </tr>
        ...
        <br />
        <a href="{{route('bukasemula.printsummary', $model->CA_CASEID)}}" target="_blank" class="btn btn-success btn-sm">Cetak</a>
        <!--</div>-->
        <!--<div class="col-sm-6">-->
