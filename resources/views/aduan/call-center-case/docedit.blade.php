...
<div class="modal-body">
    {{ Form::open(['route' => ['call-center-case.docupdate',$mCallCenterCaseDoc->id], 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'id' => 'form-edit-attachment']) }}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {{ Form::textarea('CC_REMARKS', $mCallCenterCaseDoc->CC_REMARKS, ['class' => 'form-control input-sm', 'rows' => 2]) }}
        </div>
    </div>
    <div class="row">
        <div class="form-group col-sm-12" align="center">
            <!--{{-- Form::submit('Kemaskini', ['class' => 'btn btn-primary btn-sm']) --}}-->
            {{ Form::button('Kemaskini', ['type' => 'submit', 'class' => 'btn btn-primary btn-sm ladda-button ladda-button-demo']) }}
