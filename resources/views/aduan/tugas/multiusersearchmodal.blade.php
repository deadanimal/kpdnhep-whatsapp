    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Carian Pegawai-Pegawai Lain</h4>
            </div>
...
<!--                        <div class="form-group{{-- $errors->has('role_cd') ? ' has-error' : '' --}}">
                ...
                <div class="row">
                    <div class="form-group" align="center">
                        ...
                        {{ Form::reset('Semula', ['class' => 'btn btn-default btn-sm', 'id' => 'resetbtnmulti']) }}
                    </div>
                </div>
                {!! Form::close() !!}
...
<script type="text/javascript">
    ...
    function anyCheck(id,name){
        ...
        for(var i=0; i < arr_persons.length; i++) {
            ...
            obj1.append(str);
            str = arr_persons[i].name + " <a href='#' onclick='do_remove(\""+arr_persons[i].user_id+"\")'> </i></a> <br />";
            obj2.append(str);
        }
    }
</script>