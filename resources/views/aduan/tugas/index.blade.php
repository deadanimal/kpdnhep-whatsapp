...
<!--                                    <div class="form-group">
                                        <label for="CA_INVSTS" class="col-sm-4 control-label">@lang('public-case.case.CA_CASESTS')</label>
                                        <div class="col-sm-8">
                                            {{-- Form::select('CA_INVSTS', Ref::GetList('292', true) , '', ['class' => 'form-control input-sm', 'id' => 'CA_INVSTS']) --}}
                                        </div>
                                    </div>-->
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group" align="center">
                                ...
                                <a class="btn btn-default btn-sm" href="{{ url('tugas')}}">Semula</a>
                            </div>
                        </form>
