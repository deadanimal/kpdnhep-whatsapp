...
<!--            <tr>
        ...
        <table style="width: 100%; " class="table-bordered table-stripped">
            ...
            <tr>
                ...
                <td style="width: 1%;">:</td>
                <td>@if($model->CA_ASGBY!=''){{$model->CA_ASGBY}}@endif</td>
                <td>Tarikh Penugasan</td>
                <td> : </td>
                <td>@if($model->CA_ASGDT!=''){{Carbon::parse($model->CA_ASGDT)->format('d-m-Y h:i A')}}@endif</td>
            </tr>
            <tr>
                 <td>Penyiasat</td>
                <td> : </td>
                <td>@if($model->CA_INVBY!=''){{$model->CA_INVBY}}@endif</td>
                <td>Tarikh Selesai </td>
                <td> : </td>
                <td>@if($model->CA_COMPLETEDT!=''){{Carbon::parse($model->CA_COMPLETEDT)->format('d-m-Y h:i A')}}@endif</td>
            </tr>
        </table>
        <br />
        <table style="width: 100%; " class="table-bordered table-stripped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        {!! '<a href='.Storage::disk('letter')->url($sorotan->file_name_sys).' target="_blank">'.$sorotan->file_name.'</a>' !!}
                        @endif
                    </td>
                    <td> 
        ...
        <br />
        <a href="{{route('admin-case.printsummary', $model->CA_CASEID)}}" target="_blank" class="btn btn-success btn-sm">Cetak</a>
        <!--</div>-->
        <!--<div class="col-sm-6">-->
