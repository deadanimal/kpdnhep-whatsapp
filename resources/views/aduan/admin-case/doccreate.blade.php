...
<div class="modal-body">
    {!! Form::open(['route' => ['admin-case-doc.store',$id], 'class' => 'form-horizontal', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'form-create-attachment']) !!}
    {{ csrf_field() }}
    ...
    <div id="remarks_field" class="form-group">
        ...
        <div class="col-sm-10">
            {{ Form::textarea('CC_REMARKS', '', ['class' => 'form-control input-sm', 'rows' => 2, 'style' => 'resize:vertical;']) }}
