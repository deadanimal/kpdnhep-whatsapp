            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12" align="center">
                        ...
                        <a class="btn btn-success btn-sm" href="{{ route('admin-case.preview',$model->id) }}">Simpan & Seterusnya <i class="fa fa-chevron-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function ModalAttachmentCreate(id) {
        $('#modal-create-attachment').modal("show").find("#modalCreateContent").load("{{ route('admin-case-doc.create','') }}" + "/" + id);
        return false;
    }
