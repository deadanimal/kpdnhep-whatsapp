<div class="modal-header">
    ...
    <h4 class="modal-title">@lang('button.update') @lang('public-case.case.CA_EVIDENCE')</h4>
</div>
<div class="modal-body">
    {!! Form::open(['route' => ['dataentrydocsiasat.update',$dataEntryDoc->id], 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'id' => 'form-edit-attachment']) !!}
        {{ csrf_field() }}
        {{ method_field('PUT') }}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                {{ Form::textArea('CC_REMARKS', $dataEntryDoc->CC_REMARKS, ['class' => 'form-control input-sm', 'rows' => 2]) }}
            </div>
        </div>

        <div class="row">
            <div class="form-group col-sm-12" align="center">
                {{ Form::button(trans('button.update'), [
                    'type' => 'submit', 'class' => 'ladda-button ladda-button-demo btn btn-primary btn-sm'
                ]) }}
            </div>
        </div>
    {{ Form::close() }}
