<div class="modal-header">
    ...
    <h4 class="modal-title">Kemaskini Lampiran Aduan</h4>
</div>
<div class="modal-body">
    {{ Form::open(['route' => ['kemaskini-doc.update',$modelDoc->id], 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'id' => 'form-edit-attachment']) }}
        {{ csrf_field() }}
        {{ method_field('PUT') }}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                {{ Form::textarea('CC_REMARKS', $modelDoc->CC_REMARKS, ['class' => 'form-control input-sm', 'rows' => 2]) }}
            </div>
        </div>
        <div class="row">
            <div class="form-group col-sm-12" align="center">
                {{ Form::button('Kemaskini', ['type' => 'submit', 'class' => 'btn btn-success btn-sm ladda-button ladda-button-demo']) }}
            </div>
        </div>
    {{ Form::close() }}
</div>
