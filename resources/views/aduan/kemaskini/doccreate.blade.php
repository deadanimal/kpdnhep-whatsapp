<div class="modal-header">
    ...
    <h4 class="modal-title">Tambah Lampiran Aduan</h4>
</div>
<div class="modal-body">
    {!! Form::open(['route' => 'kemaskini-doc.store', 'id' => 'form-create-attachment', 'class' => 'form-horizontal', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
        {{ csrf_field() }}
