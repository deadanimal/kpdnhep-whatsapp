...
<h2>Semakan Aduan (Maklumat Tidak Lengkap)</h2>
                ...
                {!! Form::open(['url' => ['admin-case', $model->id], 'class' => 'form-horizontal']) !!}
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div id="CA_TTPMTYP" style="display: {{ (old('CA_CMPLCAT')? (old('CA_CMPLCAT') == 'BPGK 08'? 'block':'none') : ($model->CA_CMPLCAT == 'BPGK 08'? 'block':'none')) }};" class="form-group">
                            ...
                            <div id="CA_TTPMNO" style="display: {{ (old('CA_CMPLCAT')? (old('CA_CMPLCAT') == 'BPGK 08'? 'block':'none') : ($model->CA_CMPLCAT == 'BPGK 08'? 'block':'none')) }};" class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                {{ Form::label('CA_AGAINSTNM', 'Nama (Syarikat/Premis)', ['class' => 'col-sm-5 control-label']) }}
                                <div class="col-sm-7">
                            ...
                            <table>
                                <tr>
                                    @foreach($modelDoc as $doc)
                                        <?php $ExtFile = substr($doc->CC_IMG_NAME, -3); ?>
                                        @if($ExtFile == 'pdf' || $ExtFile == 'PDF')
                                            <td style="max-width: 10%; min-width: 10%; ">
                                                <div class="p-sm text-center">
                                                    <a href="{{ Storage::disk('bahanpath')->url($doc->CC_PATH.$doc->CC_IMG) }}" target="_blank">
                                        ...
                                        @else
                                            <td style="max-width: 10%; min-width: 10%; ">
                                                <div class="p-sm text-center">
                                                    <a href="{{ Storage::disk('bahanpath')->url($doc->CC_PATH.$doc->CC_IMG) }}" target="_blank">
                                                        <img src="{{ Storage::disk('bahanpath')->url($doc->CC_PATH.$doc->CC_IMG) }}" class="img-lg img-thumbnail"/>
                                                        <br />
                                                        {{ $doc->CC_IMG_NAME }}
                                                    </a>
                                                </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12" align="center">
                            <a class="btn btn-success btn-sm" href="{{ route('kemaskini.docbuktiaduan',$model->CA_CASEID) }}"><i class="fa fa-chevron-left"></i> Sebelum</a>
                            <a class="btn btn-warning btn-sm" href="{{ url('kemaskini') }}">Kembali</a>
                            <a id="SubmitBtn" class="btn btn-success btn-sm" href="{{ route('kemaskini.submit',$model->CA_CASEID) }}">Hantar <i class="fa fa-chevron-right"></i></a>
                        </div>
                    </div>
                {!! Form::close() !!}
            </div>
