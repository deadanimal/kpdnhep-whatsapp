<div class="modal-header">
    ...
    <h4 class="modal-title">Tambah Bukti Siasatan</h4>
</div>
<div class="modal-body">
    {!! Form::open(['route' => 'sas-case.storedocsiasat', 'id' => 'form-create-attachment', 'class' => 'form-horizontal', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
        {{ csrf_field() }}
