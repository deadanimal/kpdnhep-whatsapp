...
<div class="modal-header">
    ...
    <h4 class="modal-title">Kemaskini Akta</h4>
</div>
<div class="modal-body">
    {!! Form::open(['route' => ['sas-case.updateakta',$SiasatKes->id], 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'id' =>'form-edit-kes']) !!}
        {{ csrf_field() }}
        {{ method_field('PUT') }}
        ...
        <div id="CT_AKTA_field" class="form-group {{ $errors->has('CT_AKTA') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-7">
                {{ Form::select('CT_AKTA', Ref::GetList('713', true), $SiasatKes->CT_AKTA, ['class' => 'form-control input-sm required', 'id' => 'CT_AKTA']) }}
        ...
        <div class="row">
            <div class="form-group col-sm-12" align="center">
                <button type="submit" class="ladda-button ladda-button-demo btn btn-success btn-sm">@lang('button.update')</button>
            </div>
        </div>
    {!! Form::close() !!}
</div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data['fails']) {
                    ...
                    $.ajax({
                        type : "POST",
                        url: "{{ url('sas-case/updateakta/'.$SiasatKes->id) }}",
                        dataType : "json",
