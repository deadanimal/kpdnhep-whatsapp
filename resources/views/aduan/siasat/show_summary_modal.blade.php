    ...
    <div class="row">
        ...
        <table style="width: 100%; " class="table-bordered table-stripped">
            ...
            <tr>
                ...
                <td style="width: 1%;">:</td>
                <td>@if($model->CA_ASGBY!=''){{$model->GetAsgByName->name}}@endif</td>
              ...
              <tr>
                   <td>Penyiasat</td>
                <td> : </td>
                <td>@if($model->CA_INVBY!=''){{$model->GetInvByName->name}}@endif</td>
        ...
        <br />
        <a href="{{route('siasat.printsummary', $model->CA_CASEID)}}" target="_blank" class="btn btn-success btn-sm">Cetak</a>
        <!--</div>-->
        <!--<div class="col-sm-6">-->
