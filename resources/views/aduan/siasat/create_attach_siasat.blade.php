...
<div class="modal-body">
    {!! Form::open(['route' => ['siasat.storeattachsiasat',$CASEID], 'id' => 'form-create-attachment', 'class' => 'form-horizontal', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
    {{ csrf_field() }}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            {{ Form::hidden('CC_CASEID', $CASEID, ['class' => 'form-control input-sm']) }}
        </div>
    </div>
...
//                    $('#form-create-attachment').unbind('submit').submit();
                    $.ajax({
                        type : "POST",
                        url: "{{ url('siasat/storeattachsiasat/'.$CASEID) }}",
                        dataType : "json",
...
//                            alert(data);
                            ...
                            $('#admin-case-attachment-table').DataTable({
                                ...
                                ajax: {
                                    url: "{{ url('siasat/getAttachmentSiasat/'.$CASEID) }}"
                                },
                                columns: [
