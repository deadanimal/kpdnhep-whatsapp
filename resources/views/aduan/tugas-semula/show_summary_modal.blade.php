...
<?php $t = 1; ?>
        ...
        <table style="width: 100%; " class="table-bordered table-stripped">
            ...
            <tr>
                ...
                <td style="width: 1%;">:</td>
                <td>@if($model->CA_ASGBY!=''){{$model->penugasansemulaoleh->name}}@endif</td>
...
<?php $i = 1; ?>
        ...
        <br />
        <a href="{{route('tugas-semula.printsummary', $model->CA_CASEID)}}" target="_blank" class="btn btn-success btn-sm">Cetak</a>
        <!--</div>-->
        <!--<div class="col-sm-6">-->
