...
<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            {!! Form::open(['url' => ['publicuser/updatepublic', $mUser->id], 'class' => 'form-horizontal', 'method' => 'POST']) !!}
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                {{ Form::text('username', $mUser->username, ['class' => 'form-control input-sm']) }}
                        ...
                        <div class="form-group{{ $errors->has('citizen') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                ...
                                <div>
                                    <label>{{ Form::radio('citizen', $Ctzen->code, $mUser->citizen == $Ctzen->code ? true : false, array('id'=> 'citizen'.$Ctzen->code)) }} <i></i> {{ $Ctzen->descr }} </label>
                                </div>
                                @endforeach
                        ...
                        <div id="bknwarganegara" style="display:{{$mUser->citizen == 2 ? '' : 'none'}}">
                            ...
                            <div class="col-sm-7">
                                ...
                                {{-- Form::select('ctry_cd',array
                                  ( '' => 'Pilih Negara',
                                   '1' => 'Indonesia', 
                                   '2' => 'Singapura',
                                   '3' => 'Thailand'), $mUser->ctry_cd,array('class' => 'form-control'))--}}
                            </div>
                        </div>
                        </div>
                        <div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                {{ Form::text('age', $mUser->age, ['class' => 'form-control input-sm']) }}
                                @if ($errors->has('age'))
                        ...
                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                {{ Form::textarea('address', $mUser->address, ['class' => 'form-control input-sm', 'rows'=> '2']) }}
                        ...
                        <div class="form-group{{ $errors->has('postcode') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                {{ Form::text('postcode', $mUser->postcode, ['class' => 'form-control input-sm']) }}
                        ...
                        <div class="form-group{{ $errors->has('distrinct_cd') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                {{ Form::select('distrinct_cd', $mUser->state_cd == '' ? [ '-- SILA PILIH --'] : User::GetDstrtList($mUser->state_cd), $mUser->distrinct_cd, ['class' => 'form-control input-sm', 'id' => 'distrinct_cd']) }}
                            ...
                            <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <div>
                                        <label>{{ Form::radio('gender', $Gnder->code, $mUser->gender == $Gnder->code ? true : false) }} <i></i> {{ $Gnder->descr }} </label>
                                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-8">
                                {{ Form::email('email', $mUser->email, ['class' => 'form-control input-sm required']) }}
                                @if ($errors->has('email'))
                        ...
                        <div class="form-group{{ $errors->has('lang') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-8">
                                {{ Form::select('lang', Ref::GetList('295 ', true), $mUser->lang, ['class' => 'form-control input-sm', 'id' => 'lang']) }}
                                @if ($errors->has('lang'))
                        ...
                        <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <div><label> <input type="radio" value="1" name="status" {{ $mUser->status == 1? 'checked':'' }}> <i></i> AKTIF </label></div>
                                <div><label> <input type="radio" value="2" name="status" {{ $mUser->status == 2? 'checked':'' }}> <i></i> TIDAK AKTIF </label></div>
                            </div>
                        </div>
                    </div>
                </div>
