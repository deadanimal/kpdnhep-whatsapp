        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <!--<form method="POST" id="search-form" class="form-horizontal">-->
                    {!! Form::open(['url' => ['publicuser/updatepassword', $mUser->id], 'class' => 'form-horizontal', 'method' => 'POST']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    {{ Form::label('password', 'Kata Laluan Baru', ['class' => 'col-sm-4 control-label required']) }}
                                    <div class="col-sm-8">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    {{ Form::label('password2', 'Ulang Kata Laluan Baru', ['class' => 'col-sm-4 control-label required']) }}
                                    <div class="col-sm-8">
                                        {{ Form::password('password2', ['class' => 'form-control input-sm']) }}
