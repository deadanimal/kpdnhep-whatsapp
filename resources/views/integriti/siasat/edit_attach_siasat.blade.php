...
<div class="modal-body">
    {!! Form::open(['route' => ['integritisiasat.updateattachsiasat',$mPublicCaseDoc->id], 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'id' => 'form-edit-attachment']) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {{ Form::textArea('IC_REMARKS', $mPublicCaseDoc->IC_REMARKS, ['class' => 'form-control input-sm', 'rows' => 2]) }}
        </div>
    </div>
...
//                    $('#form-edit-attachment').unbind('submit').submit();
                    $.ajax({
                        type : "POST",
                        url: "{{ url('integritisiasat/updateattachsiasat/'.$mPublicCaseDoc->id) }}",
                        dataType : "json",
                        ...
                        success: function (data) {
                            ...
                            $('#admin-case-attachment-table').DataTable({
                                ...
                                ajax: {
                                    url: "{{ url('integritisiasat/getAttachmentSiasat', str_replace('/','_',$mPublicCaseDoc->IC_CASEID)) }}"
                                },
                                columns: [
