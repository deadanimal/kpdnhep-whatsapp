...
<div class="modal-body">
    ...
    {!! Form::open([
        'route' => ['integritipublicdoc.update', $mPublicCaseDoc->id], 
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {{ Form::textArea('IC_REMARKS', $mPublicCaseDoc->IC_REMARKS, ['class' => 'form-control input-sm', 'rows' => 2, 'style'=>'resize:vertical']) }}
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group col-sm-12" align="center">
            ...
            <button id="btnsubmitupdate" class="ladda-button ladda-button-demo btn btn-sm btn-primary">
                @lang('button.update')
            </button>
        </div>
    </div>
