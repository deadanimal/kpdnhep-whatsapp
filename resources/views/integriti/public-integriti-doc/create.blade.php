...
<div class="modal-body">
    ...
    {!! Form::open([
        'route' => ['integritipublicdoc.store', $id], 
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {{ Form::textArea('IC_REMARKS', '', ['class' => 'form-control input-sm', 'rows' => 2, 'style'=>'resize:vertical']) }}
            {{ Form::hidden('IC_CASEID', $id, ['class' => 'form-control input-sm']) }}
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group col-sm-12" align="center">
            ...
            <button type="submit" id="btnsubmitcreate" class="ladda-button ladda-button-demo btn btn-success btn-sm" data-style="expand-right">
                @lang('button.add')
            </button>
        </div>
    </div>
