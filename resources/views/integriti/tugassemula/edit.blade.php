        ...
        <div class="tab-content">
            <div id="tugas-semula" class="tab-pane active">
                <div class="panel-body">
                    ...
                    {{ Form::open(['route' => ['integrititugassemula.update', $mPenugasanSemula->id], 'id' => 'tugas-semula-form', 'class' => 'form-horizontal']) }}
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <!-- {{-- Form::text('CA_CASEID', $mPenugasanSemula->IN_CASEID, ['class' => 'form-control input-sm', 'readonly' => true]) --}} -->
                                    <p class="form-control-static"><strong>{{ $mPenugasanSemula->IN_CASEID }}</strong></p>
                                </div>
                            </div>
                            <!-- <div class="form-group"> -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    {{ Form::hidden('IN_ASGBY', $mPenugasanSemula->IN_ASGBY) }}
                                    ...
                                    <!-- {{-- @endif --}} -->
                                    <!-- {{-- Form::text('', $mPenugasanSemula->asgby ? $mPenugasanSemula->asgby->name : $mPenugasanSemula->IN_ASGBY, ['class' => 'form-control input-sm', 'readonly' => true]) --}} -->
                                    <p class="form-control-static">
                                        {{ $mPenugasanSemula->asgby ? $mPenugasanSemula->asgby->name : $mPenugasanSemula->IN_ASGBY }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        @foreach ($mGabungAll as $gabung)
                                            <span class="help-block m-b-none">{{ $gabung->IR_CASEID }}</span>
                                        @endforeach
                                    </div>
                                </div>
                            @endif
                            <div class="form-group">
                                {{ Form::label('IN_INVSTS', 'Status Aduan', ['class' => 'col-lg-5 control-label']) }}
                                <div class="col-lg-7">
                                    <!-- {{-- Form::select('IN_INVSTS', Ref::GetList('1334', true, 'ms'), $mPenugasanSemula->IN_INVSTS, ['class' => 'form-control', 'disabled' => true]) --}} -->
                                    <p class="form-control-static">
                                        <strong>
                                            {{ $mPenugasanSemula->invsts ? $mPenugasanSemula->invsts->descr : $mPenugasanSemula->IN_INVSTS }}
                                        </strong>
                                    </p>
                                </div>
                            </div>
                            <div class="form-group{{ $errors->has('IN_CMPLCAT') ? ' has-error' : '' }}">
                                {{ Form::label('IN_CMPLCAT', 'Kategori Aduan', ['class' => 'col-lg-5 control-label required']) }}
                                <div class="col-lg-7">
                                    ...
                                    {{ Form::select('IN_CMPLCAT', Ref::GetList('1344', true, 'ms', 'descr'), old('IN_CMPLCAT', $mPenugasanSemula->IN_CMPLCAT), ['class' => 'form-control required']) }}
                            ...
                            <!-- <div class="form-group{{ $errors->has('CA_CMPLCD') ? ' has-error' : '' }}"> -->
                                ...
                                <!-- </div> -->
                            <!-- </div> -->
                            <div class="form-group{{ $errors->has('IN_INVBY') ? ' has-error' : '' }}">
                                {{ Form::label('IN_INVBY', 'Pegawai Penyiasat/Serbuan', ['class' => 'col-lg-5 control-label required']) }}
                                <div class="col-lg-7">
                                    <div class="input-group">
                                        {{ Form::hidden('IN_INVBY', old('IN_INVBY', $mPenugasanSemula->IN_INVBY), ['class' => 'form-control input-sm', 'id' => 'CA_INVBY_id']) }}
                                        @if($mPenugasanSemula->IN_INVBY != '')
                                            {{ Form::text('IN_INVBY_NAME', old('IN_INVBY_NAME', $mPenugasanSemula->invby ? $mPenugasanSemula->invby->name : $mPenugasanSemula->IN_INVBY), ['class' => 'form-control', 'readonly' => true, 'id' => 'CA_INVBY_name']) }}
                                        @elseif($mPenugasanSemula->IN_INVBY == '')
                                            {{ Form::text('IN_INVBY_NAME', old('IN_INVBY_NAME', ''), ['class' => 'form-control', 'readonly' => true, 'id' => 'CA_INVBY_name']) }}
                                        @endif
                                        <span class="input-group-btn">
                                            <a data-toggle="modal" class="btn btn-primary" href="#carian-penyiasat" title="Carian Pegawai Penyiasat/Serbuan">
                                                Carian
                                            </a>
                                        </span>
                                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <!-- {{-- Form::textarea('IN_SUMMARY', $mPenugasanSemula->IN_SUMMARY, ['class' => 'form-control input-sm', 'readonly' => true, 'rows'=>3]) --}} -->
                                    <p class="form-control-static">
                                        {!! nl2br(htmlspecialchars($mPenugasanSemula->IN_SUMMARY)) !!}
                                    </p>
                                </div>
                            </div>
                            <div class="form-group{{ $errors->has('ID_DESC') ? ' has-error' : '' }}">
                                {{ Form::label('ID_DESC', 'Saranan', ['class' => 'col-lg-2 control-label required']) }}
                                <div class="col-lg-10">
                                    {{ Form::textarea('ID_DESC', '', ['class' => 'form-control input-sm', 'rows'=>3]) }}
                        ...
                        <div class="col-lg-12">
                            <div class="form-group col-lg-12" align="center">
                                ...
                                {{ link_to('integrititugassemula', 'Kembali', ['class' => 'btn btn-default btn-sm']) }}
                            </div>
                        </div>
                    </div>
                    {{ Form::close() }}
    ...
    $(document).ready(function(){
        var oTable = $('#users-table').DataTable({
            ...
            ajax: {
                ...
                url: "{{ url('integrititugassemula/getdatatableuser') }}",
                data: function (d) {
                    d.name = $('#name').val();
                    d.icnew = $('#icnew').val();
