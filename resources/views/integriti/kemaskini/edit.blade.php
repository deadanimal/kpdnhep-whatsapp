    ...
    <div class="tab-content">
        <div id="caseinfo" class="tab-pane active">
            <div class="panel-body">
                {!! Form::open(['route' => ['integritikemaskini.update', $model->id], 'class' => 'form-horizontal']) !!}
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}
                    <h4>Cara Terima</h4>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <p class="form-control-static">
                                        <strong>
                                            <a 
                                                onclick="showsummaryintegriti('{{ $model->id }}')" 
                                                class="text-primary"
                                    ...
                                    <div class="radio radio-info radio-inline">
                                        ...
                                        {{ 
                                            ...
                                            (
                                                ...
                                                ? 'checked' 
                                                : ($model->IN_REFTYPE == 'TTPM' ? 'disabled' : '')
                                            )
                                        }}>
                                        <!-- onclick="againstlocation(this.value)"  -->
