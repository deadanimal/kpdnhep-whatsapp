...
<h2>Pengesahan Penutupan (Integriti)</h2>
<div class="row">
        ...
        <div class="tab-content">
            <div id="penutupan" class="tab-pane active">
                <div class="panel-body">
                    {!! Form::open(['url' => '/integrititutup/tutup-aduan/'.$mPenutupan->id,  'class'=>'form-horizontal', 'method' => 'POST']) !!}
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        {{ Form::text('IN_CASEID', $mPenutupan->IN_CASEID, ['class' => 'form-control input-sm','readonly' => true]) }}
                                    </div>
                                </div>
                                <div class="form-group">
                                    {{ Form::label('IN_ASGBY','Penugasan Aduan Oleh ', ['class' => 'col-md-4 control-label']) }}
                                    <div class="col-sm-8">
                                        {{ Form::text('IN_ASGBY_TEXT', count($mPenutupan->asgby) == '1'? $mPenutupan->asgby->name : $mPenutupan->IN_ASGBY, ['class' => 'form-control input-sm', 'readonly' => true]) }}
                                    </div>
                                </div>
                                <div class="form-group{{ $errors->has('IN_CLOSEBY') ? ' has-error' : '' }}">
                                    {{ Form::label('IN_CLOSEBY', 'Penutupan Aduan Oleh', ['class' => 'col-md-4 control-label']) }}
                                    <div class="col-sm-8">
                                        <!-- <div class="input-group"> -->
                                            {{ Form::hidden('IN_CLOSEBY', Auth::user()->id, ['class' => 'form-control input-sm', 'id' => 'CloseById']) }}
                                        ...
                                        <!-- </div> -->
                                        @if ($errors->has('IN_CLOSEBY'))
                                            <span class="help-block"><strong>{{ $errors->first('IN_CLOSEBY') }}</strong></span>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group{{ $errors->has('IN_IPSTS') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        {{ Form::text('IN_IPSTS_TEXT', Ref::GetDescr('1370', $mPenutupan->IN_IPSTS, 'ms'), ['class' => 'form-control input-sm', 'readonly' => true]) }}
                                ...
                                @if($mGabungAll)
                                    <div class="form-group">
                                        ...
                                        @foreach ($mGabungAll as $gabung)
                                            <span class="help-block m-b-none">{{ $gabung->IN_CASEID }}</span>
                                        @endforeach
                                        </div>
                                    </div>
                                @endif
                                <div class="form-group">
                                    {{ Form::label('IN_INVBY','Pegawai Penyiasat/Serbuan', ['class' => 'col-md-6 control-label']) }}
                                    <div class="col-sm-6">
                                        {{ Form::text('IN_INVBY_TEXT', count($mPenutupan->invby) == '1'? $mPenutupan->invby->name : $mPenutupan->IN_INVBY, ['class' => 'form-control input-sm', 'readonly' => true, 'id' => 'InvByName']) }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    {{ Form::label('sarananterdahulu', 'Pengesyoran Terdahulu', ['class' => 'col-sm-2 control-label']) }}
                                    <div class="col-sm-10">
                                        {{ Form::textarea('sarananterdahulu', $mPenutupanDetailOld != '' ? $mPenutupanDetailOld->ID_DESC : '', ['class' => 'form-control input-sm', 'rows' => 3, 'readonly' => true]) }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        {{ Form::textarea('IN_RESULT', $mPenutupan->IN_RESULT, ['class' => 'form-control input-sm', 'rows' => 3, 'readonly' => true]) }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    {{ Form::label('IN_CLOSE', 'Keputusan?', ['class' => 'col-sm-2 control-label required']) }}
                                    <div class="col-sm-7">
                                        <div class="radio radio-success radio-inline">
                                            <input id="yes" type="radio" value="YES" name="IN_CLOSE" onclick="check(this.value)" checked><label style="font-weight:bold" for="yes">Tutup</label>
                                        </div>
                                        <div class="radio radio-success radio-inline">
                                            <input id="no" type="radio" value="NO" name="IN_CLOSE" onclick="check(this.value)"><label style="font-weight:bold" for="no">Tolak</label>
                                        </div>
                                        @if ($errors->has('IN_CLOSE'))
                                        <span class="help-block"><strong>{{ $errors->first('IN_CLOSE') }}</strong></span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div id="inanswer" class="row">
                            <div class="col-sm-12">
                                <div class="form-group{{ $errors->has('IN_ANSWER') ? ' has-error' : '' }}">
                                    {{ Form::label('IN_ANSWER', 'Jawapan Kepada Pengadu', ['class' => 'col-sm-2 control-label required']) }}
                                    <div class="col-sm-10">
                                        {{ Form::textarea('IN_ANSWER', $mPenutupan->IN_ANSWER, ['class' => 'form-control input-sm', 'rows' => 3]) }}
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    {{ Form::label('ID_DESC','Saranan ', ['class' => 'col-md-2 control-label', 'id' => 'ID_DESC_LABEL']) }}
                                    <div class="col-sm-10">
                                        {{ Form::textarea('ID_DESC', (!empty($mPenutupanDetail)) ? $mPenutupanDetail->ID_DESC : '', ['class' => 'form-control input-sm', 'rows' => 5]) }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-sm-12" align="center">
                                @if($mPenutupan->IN_IPSTS != '09')
                                {{ Form::submit('Hantar', ['class' => 'btn btn-primary btn-sm']) }}
                                @endif
                                <a href="{{ url('integrititutup')}}" type="button" class="btn btn-default btn-sm">Kembali</a>
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>
...
<script>
    ...
    function check(value) {
        if (value == 'YES') {
            document.getElementById('ID_DESC_LABEL').innerHTML = 'Saranan';
            $('#inanswer').show();
        } else {
            document.getElementById('ID_DESC_LABEL').innerHTML = 'Alasan Tolak';
            $('#inanswer').hide();
        }
    }
