...
<h2>Kemaskini Aduan Baru (Integriti)</h2>
<div class="tabs-container">
    <ul class="nav nav-tabs">
        ...
        <li class="">
            <!-- <a href='{{ $model->IN_INVSTS == "10" ? route("admin-case.preview", $model->id) : "" }}'> -->
            <a>
                <span class="fa-stack">
    ...
    <div class="tab-content">
        <div id="caseinfo" class="tab-pane active">
            <div class="panel-body">
                {!! Form::open(['route' => ['integritiadmin.update', $model->id], 'class' => 'form-horizontal']) !!}
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}
                    <h4>Cara Terima</h4>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group{{ $errors->has('IN_RCVBY') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        {{ Form::hidden('IN_RCVBY', old('IN_RCVBY', $model->IN_RCVBY), ['class' => 'form-control input-sm', 'id' => 'RCVBY_id']) }}
                                        {{-- Form::text('', $RcvBy, ['class' => 'form-control input-sm', 'readonly' => 'true', 'id' => 'RCVBY_name']) --}}
                                        {{ Form::text('', $model->rcvby ? $model->rcvby->name : $model->IN_RCVBY, ['class' => 'form-control input-sm', 'readonly' => 'true', 'id' => 'RCVBY_name']) }}
                        ...
                        <div class="col-sm-6">
                            <div class="form-group{{ $errors->has('IN_RCVTYP') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-7">
                                    <!-- {{-- Form::select('IN_RCVTYP', AdminCase::getRefList('1353', true), old('IN_RCVTYP', $model->IN_RCVTYP), ['class' => 'form-control input-sm', 'id' => 'IN_RCVTYP']) --}} -->
                                    {{ Form::select('IN_RCVTYP', Ref::GetList('1353', true, 'ms', 'sort'), old('IN_RCVTYP', $model->IN_RCVTYP), ['class' => 'form-control input-sm']) }}
                                ...
                                <div class="col-lg-7">
                                    <!-- {{-- 
                                        Form::select(
                                            ...
                                            old('IN_CHANNEL', $model->IN_CHANNEL), 
                                            [
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group{{ $errors->has('IN_DOCNO') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-6">
                                    <!--<div class="input-group">-->
                                        {{ Form::text('IN_DOCNO', old('IN_DOCNO', $model->IN_DOCNO), ['class' => 'form-control input-sm', 'id' => 'IN_DOCNO', 'maxlength' => 12]) }}
                                        <!--<span class="input-group-btn">-->
                            ...
                            <div class="form-group{{ $errors->has('IN_EMAIL') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-6">
                                    <!--{{-- Form::text('IN_EMAIL', old('IN_EMAIL', $model->IN_EMAIL), ['class' => 'form-control input-sm']) --}}-->
                                    {{ Form::email('IN_EMAIL', old('IN_EMAIL', $model->IN_EMAIL), ['class' => 'form-control input-sm', 'id' => 'IN_EMAIL']) }}
                            ...
                            <div class="form-group{{ $errors->has('IN_MOBILENO') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-6">
                                    {{ Form::text('IN_MOBILENO', old('IN_MOBILENO', $model->IN_MOBILENO), ['class' => 'form-control input-sm', 'id' => 'IN_MOBILENO', 'onkeypress' => "return isNumberKey(event)", 'maxlength' => 12 ]) }}
                            ...
                            <div class="form-group{{ $errors->has('IN_TELNO') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-6">
                                    {{ Form::text('IN_TELNO', old('IN_TELNO', $model->IN_TELNO), ['class' => 'form-control input-sm', 'onkeypress' => "return isNumberKey(event)", 'maxlength' => 10]) }}
                            ...
                            <div class="form-group{{ $errors->has('IN_FAXNO') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-6">
                                    {{ Form::text('IN_FAXNO', old('IN_FAXNO', $model->IN_FAXNO), ['class' => 'form-control input-sm', 'onkeypress' => "return isNumberKey(event)", 'maxlength' => 10]) }}
                            ...
                            <div class="form-group{{ $errors->has('IN_ADDR') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-6">
                                    {{ Form::textarea('IN_ADDR', old('IN_ADDR', $model->IN_ADDR), ['class' => 'form-control input-sm', 'rows'=>'4', 'id' => 'IN_ADDR']) }}
                                    {{ Form::hidden('IN_MYIDENTITY_ADDR', old('IN_MYIDENTITY_ADDR', $model->IN_MYIDENTITY_ADDR), ['class' => 'form-control input-sm', 'id' => 'IN_MYIDENTITY_ADDR']) }}
                        ...
                        <div class="col-sm-6">
                            <div class="form-group{{ $errors->has('IN_NAME') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-9">
                                    {{ Form::text('IN_NAME', old('IN_NAME', $model->IN_NAME), ['class' => 'form-control input-sm', 'id' => 'IN_NAME']) }}
                            ...
                            <div class="form-group{{ $errors->has('IN_AGE') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-9">
                                    {{ Form::text('IN_AGE', old('IN_AGE', $model->IN_AGE), ['class' => 'form-control input-sm', 'id' => 'IN_AGE','onkeypress' => "return isNumberKey(event)", 'maxlength' => 3 ]) }}
                            ...
                            <div class="form-group{{ $errors->has('IN_SEXCD') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-9">
                                    {{ Form::select('IN_SEXCD', Ref::GetList('202', true, 'ms'), old('IN_SEXCD', $model->IN_SEXCD), ['class' => 'form-control input-sm', 'id' => 'IN_SEXCD']) }}
                            ...
                            <div class="form-group{{ $errors->has('IN_RACECD') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-9">
                                    {{ Form::select('IN_RACECD', Ref::GetList('580', true, 'ms'), old('IN_RACECD', $model->IN_RACECD), ['class' => 'form-control input-sm']) }}
                            ...
                            <div id="warganegara" style="display:block">
                                <div class="form-group {{ $errors->has('IN_POSTCD') ? ' has-error' : 'IN_POSTCD' }}">
                                    ...
                                    <div class="col-lg-9">
                                        {{ Form::text('IN_POSTCD', old('IN_POSTCD', $model->IN_POSTCD), ['class' => 'form-control input-sm', 'id' => 'IN_POSTCD', 'onkeypress' => "return isNumberKey(event)", 'maxlength' => 5]) }}
                                        {{ Form::hidden('IN_MYIDENTITY_POSCD', old('IN_MYIDENTITY_POSCD', $model->IN_MYIDENTITY_POSCD), ['class' => 'form-control input-sm', 'id' => 'IN_MYIDENTITY_POSCD']) }}
                                ...
                                <div class="form-group {{ $errors->has('IN_STATECD') ? ' has-error' : 'IN_STATECD' }}">
                                    ...
                                    <div class="col-lg-9">
                                        {{ Form::select('IN_STATECD', Ref::GetList('17', true, 'ms'), old('IN_STATECD', $model->IN_STATECD), ['class' => 'form-control input-sm required', 'id' => 'IN_STATECD']) }}
                                        {{ Form::hidden('IN_MYIDENTITY_STATECD', old('IN_MYIDENTITY_STATECD', $model->IN_MYIDENTITY_STATECD), ['class' => 'form-control input-sm', 'id' => 'IN_MYIDENTITY_STATECD']) }}
                                ...
                                <div class="form-group {{ $errors->has('IN_DISTCD') ? ' has-error' : 'IN_DISTCD' }}">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        ['class' => 'form-control input-sm', 'id' => 'IN_DISTCD']) }}
                                        {{ Form::hidden('IN_MYIDENTITY_DISTCD', old('IN_MYIDENTITY_DISTCD', $model->IN_MYIDENTITY_DISTCD), ['class' => 'form-control input-sm', 'id' => 'IN_MYIDENTITY_DISTCD']) }}                                        
                            ...
                            <div id="bknwarganegara" style="display: {{ (old('IN_NATCD')? (old('IN_NATCD') == '0'? 'block':'none') : ($model->IN_NATCD == '0' ? 'block' : 'none')) }}">
                                <div class="form-group {{ $errors->has('IN_COUNTRYCD') ? ' has-error' : 'IN_COUNTRYCD' }}">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        {{ Form::hidden('IN_STATUSPENGADU', old('IN_STATUSPENGADU', $model->IN_STATUSPENGADU), ['class' => 'form-control input-sm', 'id' => 'IN_STATUSPENGADU']) }}
                        ...
                        <div class="col-lg-12">
                            <div class="form-group{{ $errors->has('IN_SUMMARY') ? ' has-error' : '' }}">
                                <!--<label for="" class="col-lg-3 control-label required">-->
                                    <!--@lang('public-case.case.IN_SUMMARY')-->
                                <!--</label>-->
...
//        var status = <?php // echo $model->IN_INVSTS; ?>;
//        if(status != '10') {
...
//            $('#warganegara').hide();
    ...
    $( document ).ready(function () {
        ...
        $('#IN_AGAINST_STATECD').on('change', function (e) {
            ...
            $.ajax({
                type: 'GET',
                url: "{{ url('sas-case/getdistrictlist') }}" + "/" + IN_AGAINST_STATECD,
                dataType: "json",
                success:function(data){
                    $('select[name="IN_AGAINST_DISTCD"]').empty();
                    $.each(data, function(key, value) {
                        if(value == '0')
                            $('select[name="IN_AGAINST_DISTCD"]').append('<option value="">'+ key +'</option>');
                        else
        ...
        $('#IN_CMPLCAT').on('change', function (e) {
            ...
            if(IN_CMPLCAT === 'BPGK 19') {
                ...
                $('#div_IN_AGAINST_DISTCD').hide();
                $( "label[for='IN_ONLINECMPL_URL']" ).removeClass( "required" );
//                $( "label[for='IN_AGAINST_PREMISE']" ).removeClass( "required" );
//                $( "label[for='IN_AGAINSTADD']" ).removeClass( "required" );
//                $( "label[for='IN_AGAINST_POSTCD']" ).removeClass( "required" );
                ...
                $('#div_IN_AGAINST_STATECD').show();
                $('#div_IN_AGAINST_DISTCD').show();
//                $( "label[for='IN_AGAINST_PREMISE']" ).addClass( "required" );
//                $( "label[for='IN_AGAINSTADD']" ).addClass( "required" );
//                $( "label[for='IN_AGAINST_POSTCD']" ).addClass( "required" );
