...
<div class="modal-body">
    {{ Form::open(['route' => ['integritikemaskinidoc.store', $id], 'class' => 'form-horizontal', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'form-create-attachment']) }}
    {{ csrf_field() }}
    ...
    <div id="remarks_field" class="form-group">
