                            ...
                            <div class="row">
                                ...
                                <div style="color: #1c84c6;" 
                                    ...
                                    <div class="m-b-md">
                                        ...
                                        <h1 class="m-xs">@lang('public-case.case.CA_CASEID') : 
                                    ...
                                    <!-- </a> -->
                                    <a type="button" href="{{ url('dashboard'.'#integriti') }}" 
                                        class="btn btn-outline btn-default">
                                        @lang('public-case.case.dashboard')
                                    </a>
                                    <!-- <a type="button" href="{{ url('public-integriti/create') }}"  -->
                                        <!-- class="btn btn-outline btn-default"> -->
                                        <!-- @lang('public-case.case.newcomplaint') -->
                                    <!-- </a> -->
                                    <a type="button" target="_blank" 
                                        href="{{ url('public-integriti/printsuccess',$model->id) }}" 
                                        class="btn btn-outline btn-default">
    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceIn" id='modalEditContent' style="border-radius: 30px;">
            <div class="modal-header" 
                style="border-radius: 25px 25px 0px 0px; background: #115272; background: -moz-linear-gradient(#115272, white); color: black; text-align: center;">
