...
<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <h2>Senarai Buka Semula Aduan (Integriti)</h2>
            @include('nota')
            <div class="ibox-content">
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            {{ Form::label('IN_INVSTS', 'Status Aduan', ['class' => 'col-sm-4 control-label']) }}
                            <div class="col-sm-8">
                                {{ Form::select('IN_INVSTS', IntegritiAdmin::GetStatusList('1334',['04','05','06','08','09','011'],true), null, ['class' => 'form-control input-sm', 'id' => 'IN_INVSTS']) }}
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                {{ Form::select('IN_IPSTS', IntegritiAdmin::GetStatusList('1370',['04','05','09'],true), null, ['class' => 'form-control input-sm', 'id' => 'IN_IPSTS']) }}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group" align="center">
                    ...
                    {{ link_to('integritibukasemula', 'Semula', ['class' => 'btn btn-default btn-sm']) }}
                </div>
                {!! Form::close() !!}
                <div class="table-responsive">
                    <table id="buka-semula-table" class="table table-striped table-bordered table-hover dataTables-example" style="width: 100%">
                        <thead>
                            <tr>
                                <th>Bil.</th>
                                <th>No. Aduan</th>
...
<script type="text/javascript">
    ...
    $(function () {
        var oTable = $('#buka-semula-table').DataTable({
            processing: true,
            serverSide: true,
            bFilter: false,
            aaSorting: [],
            ...
            buttons: [
                {
                    extend: 'excel',
                    title: 'Senarai Buka Semula Aduan',
                    exportOptions: { 
                        orthogonal: 'export'
                    }
                },
            ...
            ajax: {
                url: "{{ url('integritibukasemula/getdatatablecase') }}",
                data: function (d) {
