...
<div class="modal-body">
    ...
    {!! Form::open([
        'route' => ['integritipublicuserdoc.update', $mPublicCaseDoc->id], 
        'class' => 'form-horizontal', 
        'enctype' => 'multipart/form-data', 
        'id' => 'form-edit-attachment']) 
    !!}
    {{ csrf_field() }}
    {{ method_field('PUT') }}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {{ Form::textArea('IC_REMARKS', $mPublicCaseDoc->IC_REMARKS, ['class' => 'form-control', 'rows' => 2, 'style'=>'resize:vertical']) }}
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group col-sm-12" align="center">
            ...
            <button id="btnsubmitupdate" class="ladda-button ladda-button-demo btn btn-success">
                @lang('button.update')
            </button>
        </div>
    </div>
...
<script type="text/javascript">
    $("#form-edit-attachment").submit(function(e){
        ...
        $.ajax({
            type : 'POST',
            url: "{{ url('integritipublicuserdoc/ajaxvalidateupdate') }}",
            dataType : "json",
