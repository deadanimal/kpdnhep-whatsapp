...
<div class="modal-body">
    <!-- {{-- Form::open(['route' => ['public-case-doc.store',$id], 'id' => 'form-create-attachment', 'class' => 'form-horizontal', 'method' => 'POST', 'enctype' => 'multipart/form-data']) --}} -->
    {!! Form::open([
        'route' => ['integritipublicuserdoc.store', $id], 
        'id' => 'form-create-attachment', 
    ...
    <div id="file_field" class="form-group{{ $errors->has('file') ? ' has-error' : '' }}">
        {{ Form::label('file', trans('public-case.attachment.file'), 
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {{ Form::textArea('IC_REMARKS', '', ['class' => 'form-control', 'rows' => 2, 'style'=>'resize:vertical']) }}
            {{ Form::hidden('IC_CASEID', $id, ['class' => 'form-control']) }}
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group col-sm-12" align="center">
            ...
            <button type="submit" id="btnsubmitcreate" class="ladda-button ladda-button-demo btn btn-success" data-style="expand-right">
                @lang('button.add')
            </button>
        </div>
    </div>
...
<script type="text/javascript">
    $("#form-create-attachment").submit(function(e){
        ...
        $.ajax({
            type : "POST",
            url: "{{ url('integritipublicuserdoc/ajaxvalidatestore') }}",
            dataType : "json",
