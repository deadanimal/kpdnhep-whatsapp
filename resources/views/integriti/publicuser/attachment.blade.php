                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <span style="font-size: 14px;" class="label label-success">2</span>
                            Lampiran Aduan Baru (Integriti)
                        </div>
                        <div class="panel-body">
                            ...
                            @if($count < 5 && ($model->IN_INVSTS == '010' || $model->IN_INVSTS == '07'))
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <a onclick="ModalAttachmentCreate('{{ $model->id }}')" class="btn btn-success">
                            ...
                            <div class="table-responsive">
                                <table style="width: 100%" id="public-user-integriti-attachment-table" class="table table-bordered" >
                                    <thead>
                                        <tr>
                                            <th>No.</th>
                        ...
                        <div class="panel-footer">
                            <div class="text-center">
                                ...
                                <a class="btn btn-success" href="{{ route('integritipublicuser.edit',$model->id) }}">
                                    <i class="fa fa-chevron-left"></i> {{ trans('button.previous') }}
                                </a>
                                <a class="btn btn-success" href="{{ route('integritipublicuser.preview',$model->id) }}">
...
//    });
    ...
    function ModalAttachmentCreate(id) {
        $('#modal-create-attachment')
            ...
            .load("{{ route('integritipublicuserdoc.create','') }}" + "/" + id);
        return false;
    }
    ...
    function ModalAttachmentEdit(id) {
        $('#modal-edit-attachment')
            ...
            .load("{{ route('integritipublicuserdoc.edit','') }}" + "/" + id);
        return false;
    }

    $(document).ready(function() {
        $('#public-user-integriti-attachment-table').DataTable({
            processing: true,
            serverSide: true,
            bFilter: false,
            aaSorting: [],
            ...
            ajax: {
                url: "{{ url('integritipublicuserdoc/getdatatable',$model->id) }}"
            },
            columns: [
