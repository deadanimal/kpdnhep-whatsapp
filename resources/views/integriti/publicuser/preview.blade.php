                    ...
                    <div class="form-horizontal">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <span style="font-size: 14px;" class="label label-success">3</span>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group{{ $errors->has('IN_DOCNO') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-lg-7">
                                        {{-- Form::text('IN_DOCNO', null, ['class' => 'form-control', 'placeholder' => '(ie: 570831141234)']) --}}
                                        <p>
                                            {{ $model->IN_DOCNO }}
                                        </p>
                                ...
                                <div class="form-group{{ $errors->has('IN_NAME') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-lg-7">
                                        {{-- Form::text('IN_NAME', old('IN_NAME', $model->IN_NAME), ['class' => 'form-control']) --}}
                                        <p>
                                            {{ $model->IN_NAME }}
                                        </p>
                                ...
                                <div id="bknwarganegara" style="display: {{ $model->IN_NATCD == '0' ? 'block' : 'none' }}">
                                    <div class="form-group {{ $errors->has('IN_COUNTRYCD') ? ' has-error' : 'IN_COUNTRYCD' }}">
                                        {{ Form::label('IN_COUNTRYCD', 'Negara', ['class' => 'col-lg-5 control-label']) }}
                                        <div class="col-lg-7">
                                ...
                                <div class="form-group{{ $errors->has('IN_AGAINSTNM') ? ' has-error' : '' }}">
                                    {{ Form::label('IN_AGAINSTNM', 'Nama Pegawai Yang Diadu (PYDA)', ['class' => 'col-lg-5 control-label']) }}
                                    <div class="col-lg-7">
                                        <p>
                                            {{ $model->IN_AGAINSTNM }}
                                        </p>
                                ...
                                <div id="div_bgk" 
                                    ...
                                    {{ Form::label('IN_BGK_CASEID', 'Aduan Kepenggunaan', ['class' => 'col-lg-5 control-label']) }}
                                    <div class="col-lg-7">
                                        <p>
                                            {{ $model->IN_BGK_CASEID }}
                                        </p>
                                ...
                                <div id="div_ttpm" 
                                    ...
                                    {{ Form::label('IN_TTPMNO', 'No. TTPM', ['class' => 'col-lg-5 control-label']) }}
                                    <div class="col-lg-7">
                                        <p>
                                            {{ $model->IN_TTPMNO }}
                                        </p>
                                ...
                                <div id="div_ttpmform" 
                                    ...
                                    style="display: {{ old('IN_REFTYPE') ? (old('IN_REFTYPE') == 'TTPM' ? 'block' : 'none') : ($model->IN_REFTYPE == 'TTPM' ? 'block' : 'none') }};">
                                    {{ Form::label('IN_TTPMFORM', 'Jenis Borang TTPM', ['class' => 'col-lg-5 control-label']) }}
                                    <div class="col-lg-7">
                                        <p>
                                ...
                                <div class="form-group{{ $errors->has('IN_AGAINSTLOCATION') ? ' has-error' : '' }}">
                                    {{ Form::label('IN_AGAINSTLOCATION', 'Lokasi PYDA', ['class' => 'col-lg-5 control-label']) }}
                                    <div class="col-lg-7">
                                        <p>
                                ...
                                <div id="div_IN_AGAINST_BRSTATECD" 
                                    ...
                                    <div class="col-lg-7">
                                        <p>
                                            {{ $model->againstbrstatecd ? $model->againstbrstatecd->descr : '' }}
                                        </p>
                                ...
                                <div id="div_IN_BRNCD" 
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        --}} -->
                                        <p>
                                            {{ $model->brncd ? $model->brncd->BR_BRNNM : '' }}
                                        </p>
                                    </div>
                                </div>
                                <div id="div_IN_AGENCYCD" 
                                    ...
                                    <div class="col-lg-7">
                                        <p>
                                            {{ $model->agencycd ? $model->agencycd->MI_DESC : '' }}
                                        </p>
                                ...
                                <div class="form-group">
                                    {{ Form::label('IN_SUMMARY_TITLE', 'Tajuk Aduan', ['class' => 'col-lg-5 control-label']) }}
                                    <div class="col-lg-7">
                                ...
                                <div class="form-group{{ $errors->has('IN_SUMMARY') ? ' has-error' : '' }}">
                                    {{ Form::label('IN_SUMMARY', trans('public-case.case.CA_SUMMARY'), ['class' => 'col-lg-5 control-label']) }}
                                    <div class="col-lg-7">
                                        <p>
                                            {!! nl2br(htmlspecialchars($model->IN_SUMMARY)) !!}
                                        </p>
                                        {{-- Form::textarea('IN_SUMMARY','', ['class' => 'form-control', 'rows'=> '5']) --}}
                                ...
                                <div class="bg-muted b-r-xl p-xs"><strong>Lampiran Aduan</strong></div>
                                <hr style="background-color: #ccc; height: 1px; width: 100%; border: 0;">
                            ...
                            <div class="panel-footer">
                                <div class="text-center">
                                    ...
                                    <a class="btn btn-success" href="{{ route('integritipublicuser.attachment', $model->id) }}">
                                        <i class="fa fa-chevron-left"></i> {{ trans('button.previous') }}
                                    </a>
                                    <a id="SubmitBtn" data-toggle="modal" data-target="#confirm-submit" class="btn btn-success">
        ...
        <div class="modal-content animated bounceIn" id='modalEditContent' style="border-radius: 30px;">
            ...
            <div class="modal-body" style="background: white; ">
                ...
                <div class="modal-footer" style="border-radius:0px 0px 25px 25px; background: #115272; background: -moz-linear-gradient(bottom, #115272, white); color: black;">
                    ...
                    <p class="text-center">
                        <button type="button" class="btn btn-warning" data-dismiss="modal">@lang('public-case.confirmation.btncancel')</button>
                        <button type="submit" class="btn btn-success" >@lang('public-case.confirmation.btnsubmit')</button>
                    </p>
                </div>
            {!! Form::close() !!}
        </div>
