...
<table border="1" style="width: 100%;">
    <tr>
        ...
        <td style="text-align:center;">
            ...
            @if($model->IN_EMAIL)
            <p>@lang('public-case.success.emailnotify')
                <b>{{ $model->IN_EMAIL }}</b>
            </p>
            @endif
        </td>
...
<table style="width: 100%;">
    <tr>
        <td style="width: 30%;">
            {{-- Auth::user()->lang == 'ms' ? 'Nama Pegawai Yang Diadu (PYDA)' : 'Name of Claimed Officer' --}}
            {{ 
                app()->getLocale() == 'ms' 
                ? 'Nama Pegawai Yang Diadu (PYDA)' 
                : 'Name of Claimed Officer' 
            }}
        </td>
        <td style="width: 1%;"> : </td>
    ...
    <tr>
        <td>
            {{-- Auth::user()->lang == 'ms' ? 'Tajuk Aduan' : 'Complaint Title' --}}
            {{ 
                app()->getLocale() == 'ms' 
                ? 'Tajuk Aduan' 
                : 'Complaint Title' 
