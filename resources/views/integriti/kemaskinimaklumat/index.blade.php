                ...
                <div class="ibox-content">
                    {{ Form::open(['id' => 'search-form', 'class' => 'form-horizontal']) }}
                        ...
                        <div class="form-group" align="center">
                            ...
                            {{ link_to('integritikemaskinimaklumat', 'Semula', ['class' => 'btn btn-default btn-sm']) }}
                        </div>
                    {{ Form::close() }}
...
//                order: [ 6, 'desc' ],
                ...
                ajax: {
                    ...
                    url: "{{ url('integritikemaskinimaklumat/getdatatable') }}",
                    data: function (d) {
...
//                    {extend: 'excel'},
                    {
                        extend: 'excel',
                        title: 'Senarai Maklumat Aduan Integriti',
                        exportOptions: { 
                            orthogonal: 'export'
                        }
                    },
