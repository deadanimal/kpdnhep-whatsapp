...
<div class="modal-body">
    {{ Form::open(['route' => ['sas-case.updatedoc', $mSasCaseDoc->id], 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'id' => 'form-edit-attachment']) }}
    {{ csrf_field() }}
    {{ method_field('PUT') }}
    <div id="file_field" class="form-group">
        ...
        <div class="col-sm-10">
            {{ Form::file('file') }}
            <span style="color: red;">Format : pdf, jpeg, png, gif. Maksimum 2Mb bagi setiap fail.</span>
