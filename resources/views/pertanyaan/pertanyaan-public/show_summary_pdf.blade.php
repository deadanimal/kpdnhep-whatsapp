...
<div class="modal-body">
    <div class="row">
        ...
        <br />
        <table style="width: 100%; " class="table-bordered table-stripped">
            <tr style="background: #115272;"><th colspan="3" style=" color: white; ">@lang('pertanyaan.tab.enquirysm')</th></tr>
            <tr>
        ...
        <br />
        <table style="width: 100%; " class="table-bordered table-stripped">
            <tr style="background: #115272;"><th colspan="3" style=" color: white; ">@lang('pertanyaan.table_header.enquiry.askbydetail')</th></tr>
            <tr>
...
<!--            <tr>
                <td>Jantina</td>
                <td> : </td>
                <td>{{ $model->user->gender != ''? Ref::GetDescr('202',$model->CA_SEXCD,App::getLocale()): '' }}</td>
            </tr>-->
        </table>
        <br />
        <table style="width: 100%; " class="table-bordered table-stripped">
            <tr style="background: #115272;"><th colspan="3" style=" color: white; ">@lang('pertanyaan.table_header.transaction.transaction_info')</th></tr>
            <tr>
                <th>Bil.</th>
        ...
        <br />
        <!--<a href="{{route('pertanyaan.printsummary', $model->AS_ASKID)}}" target="_blank" class="btn btn-success btn-sm">Cetak</a>-->
        <!--</div>-->
        <!--<div class="col-sm-6">-->
