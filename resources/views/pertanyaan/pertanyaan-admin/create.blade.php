...
<h2>Tambah Pertanyaan / Cadangan Baru</h2>
    ...
    <div class="tab-content">
        <div id="enq_info" class="tab-pane active">
            <div class="panel-body">
                {!! Form::open(['route' => 'pertanyaan-admin.store','class'=>'form-horizontal', 'method' => 'post']) !!}
                    {{ csrf_field() }}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group{{ $errors->has('AS_RCVTYP') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                {{ Form::select('AS_RCVTYP', PertanyaanAdmin::getAskRcvTyp('259', true), null, ['class' => 'form-control input-sm']) }}
                        ...
                        <div class="form-group{{ $errors->has('AS_DOCNO') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                {{ Form::text('AS_DOCNO', '', ['class' => 'form-control input-sm', 'id' => 'AS_DOCNO', 'maxlength' => 15 ]) }}
                        ...
                        <div class="form-group{{ $errors->has('AS_AGE') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                {{ Form::text('AS_AGE', '', ['class' => 'form-control input-sm', 'id' => 'AS_AGE', 'onkeypress' => "return isNumberKey(event)", 'maxlength' => 3 ]) }}
                        ...
                        <div class="form-group{{ $errors->has('AS_EMAIL') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                {{ Form::email('AS_EMAIL', '', ['class' => 'form-control input-sm', 'maxlength' => 191]) }}
                        ...
                        <div class="form-group{{ $errors->has('AS_MOBILENO') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                {{ Form::text('AS_MOBILENO', '', ['class' => 'form-control input-sm', 'onkeypress' => "return isNumberKey(event)", 'maxlength' => 20 ]) }}
                        ...
                        <div class="form-group{{ $errors->has('AS_ADDR') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                {{ Form::textarea('AS_ADDR', '', ['class' => 'form-control input-sm', 'rows' => '4']) }}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group{{ $errors->has('AS_NAME') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('AS_NAME', '', ['class' => 'form-control input-sm', 'id' => 'AS_NAME', 'maxlength' => 60]) }}
                        ...
                        <div class="form-group{{ $errors->has('AS_SEXCD') ? ' has-error' : '' }}"> 
                            ...
                            <div class="col-sm-9">
                                {{ Form::select('AS_SEXCD', Ref::GetList('202', true, 'ms'), null, ['class' => 'form-control input-sm', 'id' => 'AS_SEXCD']) }}
                        ...
                        <!--<div id="warganegara" style="display: {{-- (old('AS_NATCD') != ''? (old('AS_NATCD') == '1'? 'block':'none'):'block') --}}">-->
                            <div class="form-group {{ $errors->has('AS_POSCD') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('AS_POSCD', '', ['class' => 'form-control input-sm', 'onkeypress' => "return isNumberKey(event)", 'maxlength' => 5]) }}
                            ...
                            <div class="form-group {{ $errors->has('AS_STATECD') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::select('AS_STATECD', Ref::GetList('17', true, 'ms'), null, ['class' => 'form-control input-sm required', 'id' => 'AS_STATECD']) }}
                            ...
                            <div class="form-group {{ $errors->has('AS_DISTCD') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    @if (old('AS_DISTCD'))
                                        {{ Form::select('AS_DISTCD', Ref::GetListDist(old('AS_STATECD')), null, ['class' => 'form-control input-sm', 'id' => 'AS_DISTCD']) }}
                                    @else
                        ...
                        <div id="bknwarganegara" style="display: {{ (old('AS_NATCD') != ''? (old('AS_NATCD') == '0'? 'block':'none'):'none') }}">
                            <div class="form-group {{ $errors->has('AS_COUNTRYCD') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::select('AS_COUNTRYCD', Ref::GetList('334', true, 'ms'), null, ['class' => 'form-control input-sm']) }}
