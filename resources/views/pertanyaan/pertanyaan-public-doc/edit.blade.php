<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true"><i class="fa fa-close"></i></span><span class="sr-only"></span></button>
    <h4 class="modal-title">@lang('pertanyaan.title.editattachment')</h4>
</div>
<div class="modal-body">
    {!! Form::open(['route' => ['pertanyaan-public-doc.update', $model->id], 'id' => 'form-edit-attachment', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
    ...
    <div class="row">
        <div class="form-group col-sm-12" align="center">
            <button type="submit" class="ladda-button ladda-button-demo btn btn-primary btn-sm">@lang('button.update')</button>
        </div>
    </div>
    {!! Form::close() !!}
</div>
