            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        ...
                        <hr>
                        {!! Form::model($template, ['route' => ['feedback.template.update', $template->id], 'method' => 'put']) !!}
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="row">
                                    <div class="col-md-6">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                                    ...
                                    {{ Form::textarea('body', old('body'), array_merge(['id' => 'body', 'class' => 'form-control input-sm', 'rows' => 20])) }}
                                    @if ($errors->has('body'))
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    {{ Form::submit('Kemaskini', array('class' => 'btn btn-primary btn-sm')) }}
                                    <a class="btn btn-default btn-sm" href="{{ route('feedback.template.show', $template->id) }}">Kembali</a>
                                </div>
                            </div>
                        </div>
                        {!! Form::close() !!}
