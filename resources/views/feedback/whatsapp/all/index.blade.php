...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="content">
                <h2 class="m-b">Maklumbalas Melalui Whatsapp <i class="fa fa-whatsapp"></i></h2>
                <div class="box box-primary">
                    <div class="box-body">
                        @include('feedback.whatsapp.steps', ['step' => 3])
                        <div class="row">
                            <div class="col-lg-12">
    ...
    <script type="text/javascript">
      ...
      function inactive_thread(id) {
        ...
        if (confirm('Nyahaktifkan perbincangan?')) {
          $.get('/feedback/email/' + id + '/inactive', function (data) {
      ...
      $(function () {
        ...
        FeedbackTable = $('#feedback-table').DataTable({
          ...
          ajax: {
            url: "{{ url('feedback/whatsapp/all/dt')}}",
            data: function (d) {
