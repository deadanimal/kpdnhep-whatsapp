        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                @if($feeds->supporter_id === null)
                    {!! Form::open(['route' => ['whatsapp.mytask.add', $feeds->id], 'class'=>'form-horizontal']) !!}
                @elseif(auth()->user()->role->role_code == 800 || auth()->user()->role->role_code == 120)
                    {!! Form::open(['route' => ['whatsapp.mytask.release', $feeds->id], 'class'=>'form-horizontal']) !!}
                @endif
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a class="btn btn-info btn-block" href="{{ route('whatsapp.index') }}"><i
