    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <h2>Senarai Tugasan Whatsapp</h2>
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table style="width: 100%" id="mytask-table"
...
@section('script_datatable')
    <script type="text/javascript">
      ...
      $(function () {
        var MyTaskTable = $('#mytask-table').DataTable({
          processing: true,
          serverSide: true,
          bFilter: false,
          aaSorting: [],
          ...
          ajax: {
            url: "{{ url('feedback/whatsapp/dtmytask')}}",
            data: function (d) {
              d.title = $('#mytask-table #title').val()
              d.remark = $('#mytask-table #remark').val()
            }
          },
          columns: [
